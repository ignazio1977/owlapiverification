...
public class Gen_uk_ac_manchester_cs_bhig_util {
    @Test
    public void enforceInterfacesMutableTree() throws Exception {
        assertTrue(uk.ac.manchester.cs.bhig.util.Tree.class
                .isAssignableFrom(MutableTree.class));
    }

    public void verifyMutableTree() throws Exception {
    ...
    public void verifyInterfaceNodeRenderer() throws Exception {
        NodeRenderer testSubject0 = mock(NodeRenderer.class);
        java.lang.String result0 = testSubject0.render(_Tree);
    }

    public void verifyInterfaceTree() throws Exception {
    ...
    private java.lang.Object _Object4;
