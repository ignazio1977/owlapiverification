...
public class Gen_org_coode_owlapi_manchesterowlsyntax {
    ...
    public void verifyInterfaceManchesterOWLSyntaxParser() throws ParserException,
    ...
    @Test
    public void enforceInterfacesManchesterOWLSyntax() throws Exception {
        assertTrue(java.lang.Enum.class.isAssignableFrom(ManchesterOWLSyntax.class));
    }

    public void verifyEnumManchesterOWLSyntax() throws Exception {
    ...
    public void verifyManchesterOWLSyntaxClassExpressionParser() throws Exception {
    ...
    @Test
    public void enforceInterfacesManchesterOWLSyntaxClassFrameParser() throws Exception {
        assertTrue(org.semanticweb.owlapi.expression.OWLExpressionParser.class
                .isAssignableFrom(ManchesterOWLSyntaxClassFrameParser.class));
    }

    public void verifyManchesterOWLSyntaxClassFrameParser() throws Exception {
    ...
    public void verifyManchesterOWLSyntaxEditorParser() throws Exception {
        ...
        org.semanticweb.owlapi.model.OWLLiteral result2 = testSubject0.parseConstant();
        ...
        org.semanticweb.owlapi.model.OWLAxiom result5 = testSubject0.parseAxiom();
    ...
    @Test
    public void enforceInterfacesManchesterOWLSyntaxFramesParser() throws Exception {
        assertTrue(org.semanticweb.owlapi.expression.OWLExpressionParser.class
                .isAssignableFrom(ManchesterOWLSyntaxFramesParser.class));
    }

    public void verifyManchesterOWLSyntaxFramesParser() throws Exception {
    ...
    @Test
    public void enforceInterfacesManchesterOWLSyntaxInlineAxiomParser() throws Exception {
        assertTrue(org.semanticweb.owlapi.expression.OWLExpressionParser.class
                .isAssignableFrom(ManchesterOWLSyntaxInlineAxiomParser.class));
    }

    public void verifyManchesterOWLSyntaxInlineAxiomParser() throws Exception {
        ManchesterOWLSyntaxInlineAxiomParser testSubject0 = new ManchesterOWLSyntaxInlineAxiomParser(
                _OWLDataFactory, _OWLEntityChecker);
        java.lang.Object result0 = testSubject0.parse(_String);
        org.semanticweb.owlapi.model.OWLAxiom result1 = testSubject0.parse(_String);
        testSubject0.setOWLEntityChecker(_OWLEntityChecker);
    }

    @Test
    public void enforceInterfacesManchesterOWLSyntaxOntologyFormat() throws Exception {
    ...
    public void verifyManchesterOWLSyntaxOntologyFormat() throws Exception {
    ...
    public void verifyManchesterOWLSyntaxOntologyHeader() throws Exception {
        ManchesterOWLSyntaxOntologyHeader testSubject0 = new ManchesterOWLSyntaxOntologyHeader(
                _IRI, _IRI, _Set, _Set13);
        java.util.Collection<org.semanticweb.owlapi.model.OWLAnnotation> result0 = testSubject0
                .getAnnotations();
        org.semanticweb.owlapi.model.OWLOntologyID result1 = testSubject0.getOntologyID();
        java.util.Collection<org.semanticweb.owlapi.model.OWLImportsDeclaration> result2 = testSubject0
                .getImportsDeclarations();
    }

    @Test
    public void enforceInterfacesManchesterOWLSyntaxOntologyParser() throws Exception {
        assertTrue(org.semanticweb.owlapi.io.AbstractOWLParser.class
                .isAssignableFrom(ManchesterOWLSyntaxOntologyParser.class));
    }

    public void verifyManchesterOWLSyntaxOntologyParser() throws Exception {
    ...
    @Test
    public void enforceInterfacesManchesterOWLSyntaxParserException() throws Exception {
        assertTrue(org.semanticweb.owlapi.io.OWLParserException.class
                .isAssignableFrom(ManchesterOWLSyntaxParserException.class));
    }

    public void verifyManchesterOWLSyntaxParserException() throws Exception {
    ...
    @Test
    public void enforceInterfacesManchesterOWLSyntaxParserFactory() throws Exception {
        assertTrue(org.semanticweb.owlapi.io.OWLParserFactory.class
                .isAssignableFrom(ManchesterOWLSyntaxParserFactory.class));
    }

    public void verifyManchesterOWLSyntaxParserFactory() throws Exception {
    ...
    public void verifyManchesterOWLSyntaxTokenizer() throws Exception {
    ...
    public void verifyOntologyAxiomPair() throws Exception {
    ...
    private java.util.Set<org.semanticweb.owlapi.model.OWLImportsDeclaration> _Set13;
