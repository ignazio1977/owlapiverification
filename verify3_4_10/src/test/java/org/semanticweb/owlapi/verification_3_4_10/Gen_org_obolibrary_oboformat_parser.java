...
public class Gen_org_obolibrary_oboformat_parser {
    @Test
    public void enforceInterfacesInvalidXrefMapException() throws Exception {
        assertTrue(org.obolibrary.oboformat.parser.OBOFormatException.class
                .isAssignableFrom(InvalidXrefMapException.class));
    }

    public void verifyInvalidXrefMapException() throws Exception {
        ...
        InvalidXrefMapException testSubject2 = new InvalidXrefMapException(_String,
                _Throwable);
    ...
    public void verifyOBOFormatConstants() throws Exception {
    ...
    @Test
    public void enforceInterfacesOBOFormatDanglingReferenceException() throws Exception {
        assertTrue(org.obolibrary.oboformat.parser.OBOFormatException.class
                .isAssignableFrom(OBOFormatDanglingReferenceException.class));
    }

    public void verifyOBOFormatDanglingReferenceException() throws Exception {
    ...
    @Test
    public void enforceInterfacesOBOFormatException() throws Exception {
        assertTrue(org.semanticweb.owlapi.io.OWLParserException.class
                .isAssignableFrom(OBOFormatException.class));
    }

    public void verifyOBOFormatException() throws Exception {
    ...
    public void verifyOBOFormatParser() throws Exception {
        OBOFormatParser testSubject0 = new OBOFormatParser();
        org.obolibrary.oboformat.model.OBODoc result0 = testSubject0.parse(_File);
        org.obolibrary.oboformat.model.OBODoc result1 = testSubject0.parse(_String);
        ...
        java.util.List<java.lang.String> result6 = testSubject0
    ...
    @Test
    public void enforceInterfacesOBOFormatParserException() throws Exception {
        assertTrue(org.obolibrary.oboformat.parser.OBOFormatException.class
                .isAssignableFrom(OBOFormatParserException.class));
    }

    public void verifyOBOFormatParserException() throws Exception {
        OBOFormatParserException testSubject0 = new OBOFormatParserException(_Throwable,
                _int, _String);
        OBOFormatParserException testSubject1 = new OBOFormatParserException(_String,
                _int, _String);
        OBOFormatParserException testSubject2 = new OBOFormatParserException(_String,
    ...
    public void verifyXrefExpander() throws Exception {
