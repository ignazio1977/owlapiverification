...
public class Gen_org_semanticweb_owlapi_model {
    ...
    public void verifyAddAxiom() {
        ...
        java.util.Set<OWLEntity> result7 = testSubject0.getEntities();
    ...
    public void verifyAxiomType() {
        ...
        java.util.Set<OWLAxiom> result6 = AxiomType.getAxiomsWithoutTypes(_Set, _AxiomType_array);
        java.util.Set<OWLAxiom> result7 = AxiomType.getAxiomsOfTypes(_Set, _AxiomType_array);
    ...
    public void verifyIRI() throws URISyntaxException {
    ...
    public void verifyInterfaceOWLAnnotationProperty() {
        ...
        java.util.Set<OWLAnnotationProperty> result0 = testSubject0.getSuperProperties(_OWLOntology);
        java.util.Set<OWLAnnotationProperty> result1 = testSubject0.getSuperProperties(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationProperty> result2 = testSubject0.getSuperProperties(_Set48);
        java.util.Set<OWLAnnotationProperty> result3 = testSubject0.getSubProperties(_Set48);
        java.util.Set<OWLAnnotationProperty> result4 = testSubject0.getSubProperties(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationProperty> result5 = testSubject0.getSubProperties(_OWLOntology);
        boolean result6 = testSubject0.isComment();
        boolean result7 = testSubject0.isLabel();
        boolean result8 = testSubject0.isDeprecated();
        java.util.Set<OWLAnnotation> result9 = testSubject0.getAnnotations(_OWLOntology);
        java.util.Set<OWLAnnotation> result10 = testSubject0.getAnnotations(_OWLOntology, _OWLAnnotationProperty);
        ...
        java.util.Set<OWLDataProperty> result36 = testSubject0.getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result37 = testSubject0.getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result38 = testSubject0.getIndividualsInSignature();
        java.util.Set<OWLDatatype> result39 = testSubject0.getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result40 = testSubject0.getNestedClassExpressions();
    ...
    public void verifyInterfaceOWLAnonymousIndividual() {
        ...
        java.util.Set<OWLClassExpression> result4 = testSubject0.getTypes(_Set48);
        java.util.Set<OWLClassExpression> result5 = testSubject0.getTypes(_OWLOntology);
        java.util.Set<OWLIndividual> result6 = testSubject0.getObjectPropertyValues(_OWLObjectPropertyExpression, _OWLOntology);
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result7 = testSubject0.getObjectPropertyValues(_OWLOntology);
        boolean result8 = testSubject0.hasObjectPropertyValue(_OWLObjectPropertyExpression, _OWLIndividual, _OWLOntology);
        boolean result9 = testSubject0.hasDataPropertyValue(_OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        boolean result10 = testSubject0.hasNegativeObjectPropertyValue(_OWLObjectPropertyExpression, _OWLIndividual, _OWLOntology);
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result11 = testSubject0.getNegativeObjectPropertyValues(_OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result12 = testSubject0.getDataPropertyValues(_OWLOntology);
        java.util.Set<OWLLiteral> result13 = testSubject0.getDataPropertyValues(_OWLDataPropertyExpression, _OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result14 = testSubject0.getNegativeDataPropertyValues(_OWLOntology);
        boolean result15 = testSubject0.hasNegativeDataPropertyValue(_OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        java.util.Set<OWLIndividual> result16 = testSubject0.getSameIndividuals(_OWLOntology);
        java.util.Set<OWLIndividual> result17 = testSubject0.getDifferentIndividuals(_OWLOntology);
    ...
    public void verifyOWLAxiomChange() {
        ...
        java.util.Set<OWLEntity> result3 = testSubject0.getEntities();
        OWLAxiom result4 = testSubject0.getAxiom();
        testSubject0.accept(_OWLOntologyChangeVisitor);
    ...
    public void verifyInterfaceOWLClass() {
        ...
        java.util.Set<OWLClassExpression> result2 = testSubject0.getSuperClasses(_OWLOntology);
        java.util.Set<OWLClassExpression> result3 = testSubject0.getSuperClasses(_Set48);
        java.util.Set<OWLClassExpression> result4 = testSubject0.getSubClasses(_Set48);
        java.util.Set<OWLClassExpression> result5 = testSubject0.getSubClasses(_OWLOntology);
        java.util.Set<OWLClassExpression> result6 = testSubject0.getEquivalentClasses(_Set48);
        java.util.Set<OWLClassExpression> result7 = testSubject0.getEquivalentClasses(_OWLOntology);
        java.util.Set<OWLClassExpression> result8 = testSubject0.getDisjointClasses(_OWLOntology);
        java.util.Set<OWLClassExpression> result9 = testSubject0.getDisjointClasses(_Set48);
        java.util.Set<OWLIndividual> result10 = testSubject0.getIndividuals(_OWLOntology);
        java.util.Set<OWLIndividual> result11 = testSubject0.getIndividuals(_Set48);
        ...
        java.util.Set<OWLAnnotation> result37 = testSubject0.getAnnotations(_OWLOntology);
        java.util.Set<OWLAnnotation> result38 = testSubject0.getAnnotations(_OWLOntology, _OWLAnnotationProperty);
        ...
        java.util.Set<OWLAxiom> result42 = testSubject0.getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result43 = testSubject0.getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result44 = testSubject0.getAnnotationAssertionAxioms(_OWLOntology);
    ...
    public void verifyInterfaceOWLDataFactory() {
        ...
        OWLLiteral result51 = testSubject0.getOWLTypedLiteral(_int);
        OWLLiteral result52 = testSubject0.getOWLTypedLiteral(_float);
        OWLLiteral result53 = testSubject0.getOWLTypedLiteral(_boolean);
        OWLLiteral result54 = testSubject0.getOWLTypedLiteral(_double);
        OWLLiteral result55 = testSubject0.getOWLTypedLiteral(_String);
        OWLLiteral result56 = testSubject0.getOWLTypedLiteral(_String, _OWL2Datatype);
        OWLLiteral result57 = testSubject0.getOWLTypedLiteral(_String, _OWLDatatype);
        OWLLiteral result58 = testSubject0.getOWLStringLiteral(_String, _String);
        OWLLiteral result59 = testSubject0.getOWLStringLiteral(_String);
        ...
        SWRLRule result209 = testSubject0.getSWRLRule(_NodeID, _Set147, _Set147);
        SWRLRule result210 = testSubject0.getSWRLRule(_IRI, _Set147, _Set147);
    ...
    public void verifyInterfaceOWLDataProperty() {
        ...
        java.util.Set<OWLClassExpression> result2 = testSubject0.getDomains(_OWLOntology);
        java.util.Set<OWLClassExpression> result3 = testSubject0.getDomains(_Set48);
        ...
        java.util.Set<OWLDataPropertyExpression> result6 = testSubject0.getSuperProperties(_Set48);
        java.util.Set<OWLDataPropertyExpression> result7 = testSubject0.getSuperProperties(_OWLOntology);
        java.util.Set<OWLDataPropertyExpression> result8 = testSubject0.getSubProperties(_OWLOntology);
        java.util.Set<OWLDataPropertyExpression> result9 = testSubject0.getSubProperties(_Set48);
        java.util.Set<OWLDataPropertyExpression> result10 = testSubject0.getEquivalentProperties(_OWLOntology);
        java.util.Set<OWLDataPropertyExpression> result11 = testSubject0.getEquivalentProperties(_Set48);
        java.util.Set<OWLDataPropertyExpression> result12 = testSubject0.getDisjointProperties(_OWLOntology);
        java.util.Set<OWLDataPropertyExpression> result13 = testSubject0.getDisjointProperties(_Set48);
        ...
        java.util.Set<OWLAnnotation> result35 = testSubject0.getAnnotations(_OWLOntology);
        java.util.Set<OWLAnnotation> result36 = testSubject0.getAnnotations(_OWLOntology, _OWLAnnotationProperty);
        ...
        java.util.Set<OWLAxiom> result40 = testSubject0.getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result41 = testSubject0.getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result42 = testSubject0.getAnnotationAssertionAxioms(_OWLOntology);
    ...
    public void verifyInterfaceOWLDatatype() {
        ...
        boolean result23 = testSubject0.isBottomEntity();
        int result24 = testSubject0.compareTo(_Object36);
        java.util.Set<OWLAnnotation> result25 = testSubject0.getAnnotations(_OWLOntology);
        java.util.Set<OWLAnnotation> result26 = testSubject0.getAnnotations(_OWLOntology, _OWLAnnotationProperty);
        ...
        java.util.Set<OWLAxiom> result30 = testSubject0.getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result31 = testSubject0.getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result32 = testSubject0.getAnnotationAssertionAxioms(_OWLOntology);
    ...
    public void verifyInterfaceOWLDatatypeRestriction() {
        ...
        java.util.Set<OWLFacetRestriction> result1 = testSubject0.getFacetRestrictions();
        testSubject0.accept(_OWLDataRangeVisitor);
    ...
    public void verifyInterfaceOWLDifferentIndividualsAxiom() {
        ...
        java.util.Set<OWLDifferentIndividualsAxiom> result0 = testSubject0.asPairwiseAxioms();
        ...
        java.util.Set<OWLIndividual> result3 = testSubject0.getIndividuals();
        java.util.List<OWLIndividual> result4 = testSubject0.getIndividualsAsList();
    ...
    public void verifyInterfaceOWLDisjointClassesAxiom() {
        ...
        java.util.Set<OWLDisjointClassesAxiom> result0 = testSubject0.asPairwiseAxioms();
    ...
    public void verifyInterfaceOWLDisjointDataPropertiesAxiom() {
        ...
        java.util.Set<OWLDataPropertyExpression> result2 = testSubject0.getPropertiesMinus(_OWLDataPropertyExpression);
        java.util.Set<OWLAnnotation> result3 = testSubject0.getAnnotations();
        java.util.Set<OWLAnnotation> result4 = testSubject0.getAnnotations(_OWLAnnotationProperty);
        testSubject0.accept(_OWLAxiomVisitor);
        OWLObject result5 = testSubject0.accept(_OWLAxiomVisitorEx);
    ...
    public void verifyInterfaceOWLDisjointObjectPropertiesAxiom() {
        ...
        java.util.Set<OWLObjectPropertyExpression> result2 = testSubject0.getPropertiesMinus(_OWLObjectPropertyExpression);
        java.util.Set<OWLAnnotation> result3 = testSubject0.getAnnotations();
        java.util.Set<OWLAnnotation> result4 = testSubject0.getAnnotations(_OWLAnnotationProperty);
        testSubject0.accept(_OWLAxiomVisitor);
        OWLObject result5 = testSubject0.accept(_OWLAxiomVisitorEx);
    ...
    public void verifyInterfaceOWLDisjointUnionAxiom() {
        ...
        java.util.Set<OWLClassExpression> result0 = testSubject0.getClassExpressions();
    ...
    public void verifyInterfaceOWLEntity() {
        ...
        java.util.Set<OWLAxiom> result5 = testSubject0.getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result6 = testSubject0.getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result7 = testSubject0.getAnnotationAssertionAxioms(_OWLOntology);
    ...
    public void verifyInterfaceOWLEquivalentClassesAxiom() {
        ...
        java.util.Set<OWLClass> result2 = testSubject0.getNamedClasses();
        boolean result3 = testSubject0.containsNamedEquivalentClass();
        java.util.Set<OWLEquivalentClassesAxiom> result4 = testSubject0.asPairwiseAxioms();
        ...
        boolean result33 = testSubject0.isBottomEntity();
        int result34 = testSubject0.compareTo(_Object36);
        java.util.Set<OWLSubClassOfAxiom> result35 = testSubject0.asOWLSubClassOfAxioms();
    }
    ...
    public void verifyInterfaceOWLEquivalentDataPropertiesAxiom() {
        ...
        java.util.Set<OWLDataPropertyExpression> result3 = testSubject0.getPropertiesMinus(_OWLDataPropertyExpression);
        java.util.Set<OWLAnnotation> result4 = testSubject0.getAnnotations();
        java.util.Set<OWLAnnotation> result5 = testSubject0.getAnnotations(_OWLAnnotationProperty);
        testSubject0.accept(_OWLAxiomVisitor);
        OWLObject result6 = testSubject0.accept(_OWLAxiomVisitorEx);
    ...
    public void verifyInterfaceOWLEquivalentObjectPropertiesAxiom() {
        ...
        java.util.Set<OWLObjectPropertyExpression> result3 = testSubject0.getPropertiesMinus(_OWLObjectPropertyExpression);
        java.util.Set<OWLAnnotation> result4 = testSubject0.getAnnotations();
        java.util.Set<OWLAnnotation> result5 = testSubject0.getAnnotations(_OWLAnnotationProperty);
        testSubject0.accept(_OWLAxiomVisitor);
        OWLObject result6 = testSubject0.accept(_OWLAxiomVisitorEx);
    ...
    public void verifyInterfaceOWLHasKeyAxiom() {
        ...
        java.util.Set<OWLPropertyExpression<?, ?>> result1 = testSubject0.getPropertyExpressions();
    ...
    public void verifyInterfaceOWLIndividual() {
        ...
        java.util.Set<OWLClassExpression> result3 = testSubject0.getTypes(_Set48);
        java.util.Set<OWLClassExpression> result4 = testSubject0.getTypes(_OWLOntology);
        java.util.Set<OWLIndividual> result5 = testSubject0.getObjectPropertyValues(_OWLObjectPropertyExpression, _OWLOntology);
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result6 = testSubject0.getObjectPropertyValues(_OWLOntology);
        boolean result7 = testSubject0.hasObjectPropertyValue(_OWLObjectPropertyExpression, _OWLIndividual, _OWLOntology);
        boolean result8 = testSubject0.hasDataPropertyValue(_OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        boolean result9 = testSubject0.hasNegativeObjectPropertyValue(_OWLObjectPropertyExpression, _OWLIndividual, _OWLOntology);
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result10 = testSubject0.getNegativeObjectPropertyValues(_OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result11 = testSubject0.getDataPropertyValues(_OWLOntology);
        java.util.Set<OWLLiteral> result12 = testSubject0.getDataPropertyValues(_OWLDataPropertyExpression, _OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result13 = testSubject0.getNegativeDataPropertyValues(_OWLOntology);
        boolean result14 = testSubject0.hasNegativeDataPropertyValue(_OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        java.util.Set<OWLIndividual> result15 = testSubject0.getSameIndividuals(_OWLOntology);
        java.util.Set<OWLIndividual> result16 = testSubject0.getDifferentIndividuals(_OWLOntology);
        boolean result17 = testSubject0.isAnonymous();
    ...
    public void verifyInterfaceOWLInverseObjectPropertiesAxiom() {
        ...
        java.util.Set<OWLSubObjectPropertyOfAxiom> result1 = testSubject0.asSubObjectPropertyOfAxioms();
        ...
        java.util.Set<OWLObjectPropertyExpression> result5 = testSubject0.getPropertiesMinus(_OWLObjectPropertyExpression);
        java.util.Set<OWLAnnotation> result6 = testSubject0.getAnnotations();
        java.util.Set<OWLAnnotation> result7 = testSubject0.getAnnotations(_OWLAnnotationProperty);
        testSubject0.accept(_OWLAxiomVisitor);
        OWLObject result8 = testSubject0.accept(_OWLAxiomVisitorEx);
    ...
    public void verifyInterfaceOWLMutableOntology() {
        ...
        java.util.List<OWLOntologyChange> result0 = testSubject0.applyChanges(_List163);
        java.util.List<OWLOntologyChange> result1 = testSubject0.applyChange(_OWLOntologyChange);
        ...
        java.util.Set<OWLClass> result7 = testSubject0.getClassesInSignature(_boolean);
        java.util.Set<OWLClass> result8 = testSubject0.getClassesInSignature();
        java.util.Set<OWLDataProperty> result9 = testSubject0.getDataPropertiesInSignature();
        java.util.Set<OWLDataProperty> result10 = testSubject0.getDataPropertiesInSignature(_boolean);
        java.util.Set<OWLObjectProperty> result11 = testSubject0.getObjectPropertiesInSignature();
        ...
        java.util.Set<OWLClassAxiom> result24 = testSubject0.getAxioms(_OWLClass);
        java.util.Set<T> result25 = testSubject0.getAxioms(_AxiomType);
        java.util.Set<OWLAxiom> result26 = testSubject0.getAxioms();
        java.util.Set<OWLDataPropertyAxiom> result27 = testSubject0.getAxioms(_OWLDataProperty);
        java.util.Set<OWLIndividualAxiom> result28 = testSubject0.getAxioms(_OWLIndividual);
        java.util.Set<OWLAnnotationAxiom> result29 = testSubject0.getAxioms(_OWLAnnotationProperty);
        java.util.Set<OWLDatatypeDefinitionAxiom> result30 = testSubject0.getAxioms(_OWLDatatype);
        java.util.Set<OWLObjectPropertyAxiom> result31 = testSubject0.getAxioms(_OWLObjectPropertyExpression);
        ...
        boolean result43 = testSubject0.containsAxiomIgnoreAnnotations(_OWLAxiom, _boolean);
        boolean result44 = testSubject0.containsAxiomIgnoreAnnotations(_OWLAxiom);
        java.util.Set<OWLAxiom> result45 = testSubject0.getAxiomsIgnoreAnnotations(_OWLAxiom, _boolean);
        java.util.Set<OWLAxiom> result46 = testSubject0.getAxiomsIgnoreAnnotations(_OWLAxiom);
        ...
        java.util.Set<OWLEntity> result71 = testSubject0.getEntitiesInSignature(_IRI, _boolean);
        java.util.Set<OWLEntity> result72 = testSubject0.getEntitiesInSignature(_IRI);
        ...
        java.util.Set<OWLClassAssertionAxiom> result105 = testSubject0.getClassAssertionAxioms(_OWLClassExpression);
        java.util.Set<OWLClassAssertionAxiom> result106 = testSubject0.getClassAssertionAxioms(_OWLIndividual);
        ...
        testSubject0.accept(_OWLObjectVisitor);
        java.util.Set<OWLAnonymousIndividual> result115 = testSubject0.getAnonymousIndividuals();
        java.util.Set<OWLClassExpression> result116 = testSubject0.getNestedClassExpressions();
    ...
    public void verifyInterfaceOWLNamedIndividual() {
        ...
        boolean result30 = testSubject0.isBottomEntity();
        int result31 = testSubject0.compareTo(_Object36);
        java.util.Set<OWLAnnotation> result32 = testSubject0.getAnnotations(_OWLOntology);
        java.util.Set<OWLAnnotation> result33 = testSubject0.getAnnotations(_OWLOntology, _OWLAnnotationProperty);
        ...
        java.util.Set<OWLAxiom> result37 = testSubject0.getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result38 = testSubject0.getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result39 = testSubject0.getAnnotationAssertionAxioms(_OWLOntology);
    ...
    public void verifyInterfaceOWLNaryAxiom() {
        ...
        java.util.Set<? extends OWLNaryAxiom> result0 = testSubject0.asPairwiseAxioms();
        java.util.Set<OWLAnnotation> result1 = testSubject0.getAnnotations();
        java.util.Set<OWLAnnotation> result2 = testSubject0.getAnnotations(_OWLAnnotationProperty);
        testSubject0.accept(_OWLAxiomVisitor);
        OWLObject result3 = testSubject0.accept(_OWLAxiomVisitorEx);
    ...
    public void verifyInterfaceOWLNaryBooleanClassExpression() {
        ...
        java.util.List<OWLClassExpression> result0 = testSubject0.getOperandsAsList();
        java.util.Set<OWLClassExpression> result1 = testSubject0.getOperands();
    ...
    public void verifyInterfaceOWLNaryClassAxiom() {
        ...
        boolean result27 = testSubject0.isBottomEntity();
        int result28 = testSubject0.compareTo(_Object36);
        java.util.Set<? extends OWLNaryAxiom> result29 = testSubject0.asPairwiseAxioms();
        java.util.Set<OWLSubClassOfAxiom> result30 = testSubject0.asOWLSubClassOfAxioms();
    }
    ...
    public void verifyInterfaceOWLNaryIndividualAxiom() {
        ...
        boolean result25 = testSubject0.isBottomEntity();
        int result26 = testSubject0.compareTo(_Object36);
        java.util.Set<? extends OWLNaryAxiom> result27 = testSubject0.asPairwiseAxioms();
        java.util.Set<OWLSubClassOfAxiom> result28 = testSubject0.asOWLSubClassOfAxioms();
    }
    ...
    public void verifyInterfaceOWLObjectInverseOf() {
        ...
        java.util.Set<OWLObjectPropertyExpression> result4 = testSubject0.getInverses(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result5 = testSubject0.getInverses(_OWLOntology);
        ...
        java.util.Set<OWLClassExpression> result20 = testSubject0.getDomains(_OWLOntology);
        java.util.Set<OWLClassExpression> result21 = testSubject0.getDomains(_Set48);
        ...
        java.util.Set<OWLObjectPropertyExpression> result24 = testSubject0.getSuperProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result25 = testSubject0.getSuperProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result26 = testSubject0.getSubProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result27 = testSubject0.getSubProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result28 = testSubject0.getEquivalentProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result29 = testSubject0.getEquivalentProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result30 = testSubject0.getDisjointProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result31 = testSubject0.getDisjointProperties(_Set48);
        ...
        java.util.Set<OWLDataProperty> result45 = testSubject0.getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result46 = testSubject0.getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result47 = testSubject0.getIndividualsInSignature();
        java.util.Set<OWLDatatype> result48 = testSubject0.getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result49 = testSubject0.getNestedClassExpressions();
    ...
    public void verifyInterfaceOWLObjectProperty() {
        ...
        java.util.Set<OWLObjectPropertyExpression> result3 = testSubject0.getInverses(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result4 = testSubject0.getInverses(_OWLOntology);
        ...
        java.util.Set<OWLClassExpression> result19 = testSubject0.getDomains(_OWLOntology);
        java.util.Set<OWLClassExpression> result20 = testSubject0.getDomains(_Set48);
        ...
        java.util.Set<OWLObjectPropertyExpression> result23 = testSubject0.getSuperProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result24 = testSubject0.getSuperProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result25 = testSubject0.getSubProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result26 = testSubject0.getSubProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result27 = testSubject0.getEquivalentProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result28 = testSubject0.getEquivalentProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result29 = testSubject0.getDisjointProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result30 = testSubject0.getDisjointProperties(_Set48);
        ...
        java.util.Set<OWLEntity> result40 = testSubject0.getSignature();
        ...
        java.util.Set<OWLAnnotation> result52 = testSubject0.getAnnotations(_OWLOntology);
        java.util.Set<OWLAnnotation> result53 = testSubject0.getAnnotations(_OWLOntology, _OWLAnnotationProperty);
        ...
        java.util.Set<OWLAxiom> result57 = testSubject0.getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result58 = testSubject0.getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result59 = testSubject0.getAnnotationAssertionAxioms(_OWLOntology);
    ...
    public void verifyInterfaceOWLOntology() {
        ...
        java.util.Set<OWLClass> result5 = testSubject0.getClassesInSignature(_boolean);
        java.util.Set<OWLClass> result6 = testSubject0.getClassesInSignature();
        java.util.Set<OWLDataProperty> result7 = testSubject0.getDataPropertiesInSignature();
        java.util.Set<OWLDataProperty> result8 = testSubject0.getDataPropertiesInSignature(_boolean);
        java.util.Set<OWLObjectProperty> result9 = testSubject0.getObjectPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result10 = testSubject0.getObjectPropertiesInSignature(_boolean);
        java.util.Set<OWLNamedIndividual> result11 = testSubject0.getIndividualsInSignature();
        java.util.Set<OWLNamedIndividual> result12 = testSubject0.getIndividualsInSignature(_boolean);
        java.util.Set<OWLDatatype> result13 = testSubject0.getDatatypesInSignature();
        java.util.Set<OWLDatatype> result14 = testSubject0.getDatatypesInSignature(_boolean);
        boolean result15 = testSubject0.isAnonymous();
        OWLOntologyManager result16 = testSubject0.getOWLOntologyManager();
        java.util.Set<IRI> result17 = testSubject0.getDirectImportsDocuments();
        java.util.Set<OWLOntology> result18 = testSubject0.getDirectImports();
        java.util.Set<OWLOntology> result19 = testSubject0.getImports();
        java.util.Set<OWLOntology> result20 = testSubject0.getImportsClosure();
        java.util.Set<OWLImportsDeclaration> result21 = testSubject0.getImportsDeclarations();
        java.util.Set<OWLClassAxiom> result22 = testSubject0.getAxioms(_OWLClass);
        java.util.Set<T> result23 = testSubject0.getAxioms(_AxiomType);
        java.util.Set<OWLAxiom> result24 = testSubject0.getAxioms();
        java.util.Set<OWLDataPropertyAxiom> result25 = testSubject0.getAxioms(_OWLDataProperty);
        java.util.Set<OWLIndividualAxiom> result26 = testSubject0.getAxioms(_OWLIndividual);
        java.util.Set<OWLAnnotationAxiom> result27 = testSubject0.getAxioms(_OWLAnnotationProperty);
        java.util.Set<OWLDatatypeDefinitionAxiom> result28 = testSubject0.getAxioms(_OWLDatatype);
        java.util.Set<OWLObjectPropertyAxiom> result29 = testSubject0.getAxioms(_OWLObjectPropertyExpression);
        ...
        java.util.Set<OWLLogicalAxiom> result34 = testSubject0.getLogicalAxioms();
        int result35 = testSubject0.getLogicalAxiomCount();
        java.util.Set<OWLAxiom> result36 = testSubject0.getTBoxAxioms(_boolean);
        java.util.Set<OWLAxiom> result37 = testSubject0.getABoxAxioms(_boolean);
        java.util.Set<OWLAxiom> result38 = testSubject0.getRBoxAxioms(_boolean);
        boolean result39 = testSubject0.containsAxiom(_OWLAxiom);
        boolean result40 = testSubject0.containsAxiom(_OWLAxiom, _boolean);
        boolean result41 = testSubject0.containsAxiomIgnoreAnnotations(_OWLAxiom, _boolean);
        boolean result42 = testSubject0.containsAxiomIgnoreAnnotations(_OWLAxiom);
        java.util.Set<OWLAxiom> result43 = testSubject0.getAxiomsIgnoreAnnotations(_OWLAxiom, _boolean);
        java.util.Set<OWLAxiom> result44 = testSubject0.getAxiomsIgnoreAnnotations(_OWLAxiom);
        java.util.Set<OWLClassAxiom> result45 = testSubject0.getGeneralClassAxioms();
        java.util.Set<OWLAnonymousIndividual> result46 = testSubject0.getReferencedAnonymousIndividuals();
        java.util.Set<OWLAnnotationProperty> result47 = testSubject0.getAnnotationPropertiesInSignature();
        java.util.Set<OWLAxiom> result48 = testSubject0.getReferencingAxioms(_OWLAnonymousIndividual);
        java.util.Set<OWLAxiom> result49 = testSubject0.getReferencingAxioms(_OWLEntity);
        java.util.Set<OWLAxiom> result50 = testSubject0.getReferencingAxioms(_OWLEntity, _boolean);
        ...
        boolean result63 = testSubject0.containsAnnotationPropertyInSignature(_IRI, _boolean);
        ...
        java.util.Set<OWLEntity> result69 = testSubject0.getEntitiesInSignature(_IRI, _boolean);
        java.util.Set<OWLEntity> result70 = testSubject0.getEntitiesInSignature(_IRI);
        java.util.Set<OWLSubAnnotationPropertyOfAxiom> result71 = testSubject0.getSubAnnotationPropertyOfAxioms(_OWLAnnotationProperty);
        java.util.Set<OWLAnnotationPropertyDomainAxiom> result72 = testSubject0.getAnnotationPropertyDomainAxioms(_OWLAnnotationProperty);
        java.util.Set<OWLAnnotationPropertyRangeAxiom> result73 = testSubject0.getAnnotationPropertyRangeAxioms(_OWLAnnotationProperty);
        java.util.Set<OWLDeclarationAxiom> result74 = testSubject0.getDeclarationAxioms(_OWLEntity);
        java.util.Set<OWLAnnotationAssertionAxiom> result75 = testSubject0.getAnnotationAssertionAxioms(_OWLAnnotationSubject);
        java.util.Set<OWLSubClassOfAxiom> result76 = testSubject0.getSubClassAxiomsForSubClass(_OWLClass);
        java.util.Set<OWLSubClassOfAxiom> result77 = testSubject0.getSubClassAxiomsForSuperClass(_OWLClass);
        java.util.Set<OWLEquivalentClassesAxiom> result78 = testSubject0.getEquivalentClassesAxioms(_OWLClass);
        java.util.Set<OWLDisjointClassesAxiom> result79 = testSubject0.getDisjointClassesAxioms(_OWLClass);
        java.util.Set<OWLDisjointUnionAxiom> result80 = testSubject0.getDisjointUnionAxioms(_OWLClass);
        java.util.Set<OWLHasKeyAxiom> result81 = testSubject0.getHasKeyAxioms(_OWLClass);
        java.util.Set<OWLSubObjectPropertyOfAxiom> result82 = testSubject0.getObjectSubPropertyAxiomsForSubProperty(_OWLObjectPropertyExpression);
        java.util.Set<OWLSubObjectPropertyOfAxiom> result83 = testSubject0.getObjectSubPropertyAxiomsForSuperProperty(_OWLObjectPropertyExpression);
        java.util.Set<OWLObjectPropertyDomainAxiom> result84 = testSubject0.getObjectPropertyDomainAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLObjectPropertyRangeAxiom> result85 = testSubject0.getObjectPropertyRangeAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLInverseObjectPropertiesAxiom> result86 = testSubject0.getInverseObjectPropertyAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLEquivalentObjectPropertiesAxiom> result87 = testSubject0.getEquivalentObjectPropertiesAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLDisjointObjectPropertiesAxiom> result88 = testSubject0.getDisjointObjectPropertiesAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLFunctionalObjectPropertyAxiom> result89 = testSubject0.getFunctionalObjectPropertyAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLInverseFunctionalObjectPropertyAxiom> result90 = testSubject0.getInverseFunctionalObjectPropertyAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLSymmetricObjectPropertyAxiom> result91 = testSubject0.getSymmetricObjectPropertyAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLAsymmetricObjectPropertyAxiom> result92 = testSubject0.getAsymmetricObjectPropertyAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLReflexiveObjectPropertyAxiom> result93 = testSubject0.getReflexiveObjectPropertyAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLIrreflexiveObjectPropertyAxiom> result94 = testSubject0.getIrreflexiveObjectPropertyAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLTransitiveObjectPropertyAxiom> result95 = testSubject0.getTransitiveObjectPropertyAxioms(_OWLObjectPropertyExpression);
        java.util.Set<OWLSubDataPropertyOfAxiom> result96 = testSubject0.getDataSubPropertyAxiomsForSubProperty(_OWLDataProperty);
        java.util.Set<OWLSubDataPropertyOfAxiom> result97 = testSubject0.getDataSubPropertyAxiomsForSuperProperty(_OWLDataPropertyExpression);
        java.util.Set<OWLDataPropertyDomainAxiom> result98 = testSubject0.getDataPropertyDomainAxioms(_OWLDataProperty);
        java.util.Set<OWLDataPropertyRangeAxiom> result99 = testSubject0.getDataPropertyRangeAxioms(_OWLDataProperty);
        java.util.Set<OWLEquivalentDataPropertiesAxiom> result100 = testSubject0.getEquivalentDataPropertiesAxioms(_OWLDataProperty);
        java.util.Set<OWLDisjointDataPropertiesAxiom> result101 = testSubject0.getDisjointDataPropertiesAxioms(_OWLDataProperty);
        java.util.Set<OWLFunctionalDataPropertyAxiom> result102 = testSubject0.getFunctionalDataPropertyAxioms(_OWLDataPropertyExpression);
        java.util.Set<OWLClassAssertionAxiom> result103 = testSubject0.getClassAssertionAxioms(_OWLClassExpression);
        java.util.Set<OWLClassAssertionAxiom> result104 = testSubject0.getClassAssertionAxioms(_OWLIndividual);
        java.util.Set<OWLDataPropertyAssertionAxiom> result105 = testSubject0.getDataPropertyAssertionAxioms(_OWLIndividual);
        java.util.Set<OWLObjectPropertyAssertionAxiom> result106 = testSubject0.getObjectPropertyAssertionAxioms(_OWLIndividual);
        java.util.Set<OWLNegativeObjectPropertyAssertionAxiom> result107 = testSubject0.getNegativeObjectPropertyAssertionAxioms(_OWLIndividual);
        java.util.Set<OWLNegativeDataPropertyAssertionAxiom> result108 = testSubject0.getNegativeDataPropertyAssertionAxioms(_OWLIndividual);
        java.util.Set<OWLSameIndividualAxiom> result109 = testSubject0.getSameIndividualAxioms(_OWLIndividual);
        java.util.Set<OWLDifferentIndividualsAxiom> result110 = testSubject0.getDifferentIndividualAxioms(_OWLIndividual);
        java.util.Set<OWLDatatypeDefinitionAxiom> result111 = testSubject0.getDatatypeDefinitions(_OWLDatatype);
        OWLObject result112 = testSubject0.accept(_OWLObjectVisitorEx);
        testSubject0.accept(_OWLObjectVisitor);
        java.util.Set<OWLAnonymousIndividual> result113 = testSubject0.getAnonymousIndividuals();
        java.util.Set<OWLClassExpression> result114 = testSubject0.getNestedClassExpressions();
    ...
    public void verifyOWLOntologyChangeException() {
        OWLOntologyChangeException testSubject0 = new OWLOntologyChangeException(_OWLOntologyChange, _Throwable);
        OWLOntologyChangeException testSubject1 = new OWLOntologyChangeException(_OWLOntologyChange, _String, _Throwable);
        OWLOntologyChangeException testSubject2 = new OWLOntologyChangeException(_OWLOntologyChange, _String);
        OWLOntologyChange result0 = testSubject0.getChange();
        testSubject0.printStackTrace();
        testSubject0.printStackTrace(_PrintWriter);
        testSubject0.printStackTrace(_PrintStream);
    ...
    public void verifyInterfaceOWLOntologyFactory() throws OWLOntologyCreationException {
        ...
        OWLOntology result2 = testSubject0.loadOWLOntology(_OWLOntologyDocumentSource, _OWLOntologyCreationHandler, _OWLOntologyLoaderConfiguration);
        boolean result3 = testSubject0.canCreateFromDocumentIRI(_IRI);
        OWLOntology result4 = testSubject0.createOWLOntology(_OWLOntologyID, _IRI, _OWLOntologyCreationHandler);
    ...
    public void verifyOWLOntologyID() {
        ...
        IRI result6 = testSubject0.getDefaultDocumentIRI();
    }
    ...
    public void verifyOWLOntologyLoaderConfiguration() {
        ...
        OWLOntologyLoaderConfiguration.MissingOntologyHeaderStrategy result2 = testSubject0.getMissingOntologyHeaderStrategy();
        ...
        java.util.Set<IRI> result11 = testSubject0.getIgnoredImports();
    ...
    public void verifyInterfaceOWLOntologyManager() throws OWLOntologyStorageException, OWLOntologyCreationException {
        ...
        java.util.Set<OWLOntology> result4 = testSubject0.getDirectImports(_OWLOntology);
        java.util.Set<OWLOntology> result5 = testSubject0.getImports(_OWLOntology);
        java.util.Set<OWLOntology> result6 = testSubject0.getImportsClosure(_OWLOntology);
        OWLDataFactory result7 = testSubject0.getOWLDataFactory();
        java.util.Set<OWLOntology> result8 = testSubject0.getOntologies();
        java.util.Set<OWLOntology> result9 = testSubject0.getOntologies(_OWLAxiom);
        java.util.Set<OWLOntology> result10 = testSubject0.getVersions(_IRI);
        boolean result11 = testSubject0.containsVersion(_IRI);
        java.util.Set<OWLOntologyID> result12 = testSubject0.getOntologyIDsByVersion(_IRI);
        OWLOntology result13 = testSubject0.getImportedOntology(_OWLImportsDeclaration);
        java.util.List<OWLOntology> result14 = testSubject0.getSortedImportsClosure(_OWLOntology);
        java.util.List<OWLOntologyChange> result15 = testSubject0.applyChanges(_List);
        java.util.List<OWLOntologyChange> result16 = testSubject0.addAxioms(_OWLOntology, _Set194);
        java.util.List<OWLOntologyChange> result17 = testSubject0.addAxiom(_OWLOntology, _OWLAxiom);
        java.util.List<OWLOntologyChange> result18 = testSubject0.removeAxiom(_OWLOntology, _OWLAxiom);
        java.util.List<OWLOntologyChange> result19 = testSubject0.removeAxioms(_OWLOntology, _Set194);
        java.util.List<OWLOntologyChange> result20 = testSubject0.applyChange(_OWLOntologyChange);
        ...
        java.util.Collection<OWLOntologyFactory> result36 = testSubject0.getOntologyFactories();
    ...
    public void verifyInterfaceOWLOntologyManagerFactory() {
        ...
        OWLOntologyManager result1 = testSubject0.buildOWLOntologyManager(_OWLDataFactory);
        OWLOntologyManager result2 = testSubject0.buildOWLOntologyManager();
    }
    ...
    public void verifyInterfaceOWLProperty() {
        ...
        java.util.Set<OWLClassExpression> result2 = testSubject0.getDomains(_Set48);
        ...
        java.util.Set<OWLObjectPropertyExpression> result5 = testSubject0.getSuperProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result6 = testSubject0.getSuperProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result7 = testSubject0.getSubProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result8 = testSubject0.getSubProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result9 = testSubject0.getEquivalentProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result10 = testSubject0.getEquivalentProperties(_Set48);
        java.util.Set<OWLObjectPropertyExpression> result11 = testSubject0.getDisjointProperties(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result12 = testSubject0.getDisjointProperties(_Set48);
        ...
        java.util.Set<OWLAnnotation> result34 = testSubject0.getAnnotations(_OWLOntology);
        java.util.Set<OWLAnnotation> result35 = testSubject0.getAnnotations(_OWLOntology, _OWLAnnotationProperty);
        ...
        java.util.Set<OWLAxiom> result39 = testSubject0.getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result40 = testSubject0.getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result41 = testSubject0.getAnnotationAssertionAxioms(_OWLOntology);
    ...
    public void verifyInterfaceOWLSameIndividualAxiom() {
        ...
        java.util.Set<OWLSameIndividualAxiom> result0 = testSubject0.asPairwiseAxioms();
        boolean result1 = testSubject0.containsAnonymousIndividuals();
    ...
    public void verifyInterfaceOWLSubPropertyChainOfAxiom() {
        ...
        java.util.List<OWLObjectPropertyExpression> result1 = testSubject0.getPropertyChain();
    ...
    public void verifyInterfaceSWRLBuiltInAtom() {
        ...
        java.util.List<SWRLDArgument> result2 = testSubject0.getArguments();
    ...
    public void verifyInterfaceSWRLDataFactory() {
        ...
        SWRLRule result2 = testSubject0.getSWRLRule(_NodeID, _Set147, _Set147);
        SWRLRule result3 = testSubject0.getSWRLRule(_IRI, _Set147, _Set147);
    ...
    public void verifyInterfaceSWRLRule() {
        ...
        java.util.Set<SWRLAtom> result2 = testSubject0.getBody();
        java.util.Set<SWRLAtom> result3 = testSubject0.getHead();
        java.util.Set<SWRLVariable> result4 = testSubject0.getVariables();
