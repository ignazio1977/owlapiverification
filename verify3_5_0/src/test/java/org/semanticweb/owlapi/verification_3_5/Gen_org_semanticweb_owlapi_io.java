...
public class Gen_org_semanticweb_owlapi_io {
    ...
    public void verifyAbstractOWLParser() throws OWLParserException, UnloadableImportException, IOException {
        AbstractOWLParser testSubject0 = new AbstractOWLParser() {
            @Override
            public OWLOntologyFormat parse(OWLOntologyDocumentSource documentSource, OWLOntology ontology) throws OWLParserException, IOException, OWLOntologyChangeException,
                    UnloadableImportException {
                return null;
            }

            @Override
            public OWLOntologyFormat parse(OWLOntologyDocumentSource documentSource, OWLOntology ontology, OWLOntologyLoaderConfiguration configuration) throws OWLParserException,
    ...
    public void enforceInterfacesDefaultOntologyFormat() {
        assertTrue(org.semanticweb.owlapi.io.RDFXMLOntologyFormat.class.isAssignableFrom(DefaultOntologyFormat.class));
    }
    ...
    public void verifyDefaultOntologyFormat() {
        ...
        org.semanticweb.owlapi.vocab.PrefixOWLOntologyFormat result13 = testSubject0.asPrefixOWLOntologyFormat();
    ...
    public void verifyGZipFileDocumentSource() {
        ...
        boolean result3 = testSubject0.isInputStreamAvailable();
        IRI result4 = testSubject0.getDocumentIRI();
        IRI result5 = GZipFileDocumentSource.getNextDocumentIRI();
    }
    ...
    public void verifyGZipStreamDocumentSource() {
        ...
        GZipStreamDocumentSource testSubject1 = new GZipStreamDocumentSource(_InputStream, _IRI);
        java.io.InputStream result0 = testSubject0.getInputStream();
        boolean result1 = testSubject0.isReaderAvailable();
        java.io.Reader result2 = testSubject0.getReader();
        boolean result3 = testSubject0.isInputStreamAvailable();
        IRI result4 = testSubject0.getDocumentIRI();
        IRI result5 = GZipStreamDocumentSource.getNextDocumentIRI();
    }
    ...
    public void enforceInterfacesOWLFunctionalSyntaxOntologyFormat() {
        assertTrue(org.semanticweb.owlapi.vocab.PrefixOWLOntologyFormat.class.isAssignableFrom(OWLFunctionalSyntaxOntologyFormat.class));
    }
    ...
    public void verifyOWLParserFactoryRegistry() {
        ...
        java.util.List<org.semanticweb.owlapi.io.OWLParserFactory> result1 = testSubject0.getParserFactories();
    ...
    public void enforceInterfacesOWLParserIOException() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserException.class.isAssignableFrom(OWLParserIOException.class));
    }
    ...
    public void enforceInterfacesOWLParserSAXException() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserException.class.isAssignableFrom(OWLParserSAXException.class));
    }
    ...
    public void enforceInterfacesOWLParserURISyntaxException() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserException.class.isAssignableFrom(OWLParserURISyntaxException.class));
    }

    public void verifyOWLParserURISyntaxException() {
        OWLParserURISyntaxException testSubject0 = new OWLParserURISyntaxException(_URISyntaxException, _int, _int);
    ...
    public void enforceInterfacesOWLXMLOntologyFormat() {
        assertTrue(org.semanticweb.owlapi.vocab.PrefixOWLOntologyFormat.class.isAssignableFrom(OWLXMLOntologyFormat.class));
    }
    ...
    public void enforceInterfacesRDFOntologyFormat() {
        assertTrue(org.semanticweb.owlapi.vocab.PrefixOWLOntologyFormat.class.isAssignableFrom(RDFOntologyFormat.class));
    }
    ...
    public void verifyRDFTriple() {
        RDFTriple testSubject0 = new RDFTriple(_IRI, _boolean, _IRI, _boolean, _OWLLiteral);
        RDFTriple testSubject1 = new RDFTriple(_IRI, _boolean, _IRI, _boolean, _IRI, _boolean);
    ...
    public void enforceInterfacesRDFXMLOntologyFormat() {
        assertTrue(org.semanticweb.owlapi.io.RDFOntologyFormat.class.isAssignableFrom(RDFXMLOntologyFormat.class));
    }
