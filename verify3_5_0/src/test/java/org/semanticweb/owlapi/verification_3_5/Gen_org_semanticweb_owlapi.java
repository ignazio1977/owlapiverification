...
public class Gen_org_semanticweb_owlapi {
    ...
    public void enforceInterfacesAbstractCompositeOntologyChange() {
        assertTrue(org.semanticweb.owlapi.OWLCompositeOntologyChange.class.isAssignableFrom(AbstractCompositeOntologyChange.class));
    }

    public void verifyAbstractCompositeOntologyChange() {
        AbstractCompositeOntologyChange testSubject0 = new AbstractCompositeOntologyChange(_OWLDataFactory) {
            @Override
    ...
    public void enforceInterfacesAddClassExpressionClosureAxiom() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(AddClassExpressionClosureAxiom.class));
    }
    ...
    public void enforceInterfacesAmalgamateSubClassAxioms() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(AmalgamateSubClassAxioms.class));
    }

    public void verifyAmalgamateSubClassAxioms() {
        AmalgamateSubClassAxioms testSubject0 = new AmalgamateSubClassAxioms(_Set, _OWLDataFactory);
        java.util.List<OWLOntologyChange> result0 = testSubject0.getChanges();
    }

    @Test
    public void enforceInterfacesCoerceConstantsIntoDataPropertyRange() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(CoerceConstantsIntoDataPropertyRange.class));
    }
    ...
    public void enforceInterfacesConvertEquivalentClassesToSuperClasses() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(ConvertEquivalentClassesToSuperClasses.class));
    }
    ...
    public void enforceInterfacesConvertPropertyAssertionsToAnnotations() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(ConvertPropertyAssertionsToAnnotations.class));
    }
    ...
    public void enforceInterfacesConvertSuperClassesToEquivalentClass() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(ConvertSuperClassesToEquivalentClass.class));
    }
    ...
    public void enforceInterfacesCreateValuePartition() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(CreateValuePartition.class));
    }
    ...
    public void enforceInterfacesMakeClassesMutuallyDisjoint() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(MakeClassesMutuallyDisjoint.class));
    }
    ...
    public void enforceInterfacesMakePrimitiveSubClassesMutuallyDisjoint() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(MakePrimitiveSubClassesMutuallyDisjoint.class));
    }

    public void verifyMakePrimitiveSubClassesMutuallyDisjoint() {
        MakePrimitiveSubClassesMutuallyDisjoint testSubject0 = new MakePrimitiveSubClassesMutuallyDisjoint(_OWLDataFactory, _OWLClass, _Set, _OWLOntology);
        MakePrimitiveSubClassesMutuallyDisjoint testSubject1 = new MakePrimitiveSubClassesMutuallyDisjoint(_OWLDataFactory, _OWLClass, _Set, _OWLOntology, _boolean);
        java.util.List<OWLOntologyChange> result0 = testSubject0.getChanges();
    }
    ...
    public void enforceInterfacesRemoveAllDisjointAxioms() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(RemoveAllDisjointAxioms.class));
    }
    ...
    public void enforceInterfacesShortForm2AnnotationGenerator() {
        assertTrue(org.semanticweb.owlapi.OWLCompositeOntologyChange.class.isAssignableFrom(ShortForm2AnnotationGenerator.class));
    }

    public void verifyShortForm2AnnotationGenerator() {
        ShortForm2AnnotationGenerator testSubject0 = new ShortForm2AnnotationGenerator(_OWLOntologyManager, _OWLOntology, _ShortFormProvider, _IRI, _String);
        ShortForm2AnnotationGenerator testSubject1 = new ShortForm2AnnotationGenerator(_OWLOntologyManager, _OWLOntology, _ShortFormProvider, _IRI);
        java.util.List<OWLOntologyChange> result0 = testSubject0.getChanges();
    }

    @Test
    public void enforceInterfacesSplitSubClassAxioms() {
        assertTrue(org.semanticweb.owlapi.AbstractCompositeOntologyChange.class.isAssignableFrom(SplitSubClassAxioms.class));
    }
