...
public class Gen_org_coode_owl_krssparser {
    ...
    public void verifyKRSSOWLParser() throws OWLParserException, OWLOntologyChangeException, UnloadableImportException, IOException {
    ...
    public void enforceInterfacesKRSSOWLParserException() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserException.class.isAssignableFrom(KRSSOWLParserException.class));
    }
    ...
    public void enforceInterfacesKRSSOWLParserFactory() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserFactory.class.isAssignableFrom(KRSSOWLParserFactory.class));
    }
    ...
    public void enforceInterfacesKRSSParser() {
        assertTrue(org.coode.owl.krssparser.KRSSParserConstants.class.isAssignableFrom(KRSSParser.class));
    }

    public void verifyKRSSParser() throws ParseException {
        ...
        OWLAxiom result2 = testSubject0.TBoxStatement();
        OWLAxiom result3 = testSubject0.Range();
        OWLAxiom result4 = testSubject0.ABoxStatement();
        OWLAxiom result5 = testSubject0.DefinePrimitiveConcept();
        OWLAxiom result6 = testSubject0.DefineConcept();
        OWLAxiom result7 = testSubject0.DefinePrimitiveRole();
        OWLAxiom result8 = testSubject0.Transitive();
        OWLClassExpression result9 = testSubject0.ConceptName();
        OWLClassExpression result10 = testSubject0.ConceptExpression();
        OWLObjectProperty result11 = testSubject0.RoleName();
        OWLClassExpression result12 = testSubject0.And();
        OWLClassExpression result13 = testSubject0.Or();
        OWLClassExpression result14 = testSubject0.Not();
        OWLClassExpression result15 = testSubject0.Some();
        OWLClassExpression result16 = testSubject0.AtLeast();
        OWLClassExpression result17 = testSubject0.AtMost();
        OWLClassExpression result18 = testSubject0.Exactly();
        java.util.Set<OWLClassExpression> result19 = testSubject0.ConceptSet();
        OWLAxiom result20 = testSubject0.Instance();
        OWLAxiom result21 = testSubject0.Related();
        OWLAxiom result22 = testSubject0.Equal();
        OWLAxiom result23 = testSubject0.Distinct();
        OWLIndividual result24 = testSubject0.IndividualName();
        org.coode.owl.krssparser.Token result25 = testSubject0.getNextToken();
        org.coode.owl.krssparser.ParseException result26 = testSubject0.generateParseException();
        ...
        IRI result28 = testSubject0.getIRI(_String);
        OWLClassExpression result29 = testSubject0.All();
    }
    ...
    public void enforceInterfacesKRSSParserTokenManager() {
        assertTrue(org.coode.owl.krssparser.KRSSParserConstants.class.isAssignableFrom(KRSSParserTokenManager.class));
    }
