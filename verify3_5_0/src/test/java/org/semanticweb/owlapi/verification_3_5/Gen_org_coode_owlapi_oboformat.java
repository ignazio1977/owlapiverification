...
public class Gen_org_coode_owlapi_oboformat {
    ...
    public void verifyOBOFormatOWLAPIParser()  {
        ...
        OWLOntologyFormat result2 = testSubject0.parse(_IRI,
                _OWLOntology);
    ...
    public void verifyOBOFormatRenderer()  {
    ...
    public void verifyOBOFormatStorer()  {
