...
public class Gen_org_coode_owlapi_functionalparser {
    ...
    public void verifyOWLFunctionalSyntaxOWLParser() throws OWLParserException, UnloadableImportException, IOException {
    ...
    public void enforceInterfacesOWLFunctionalSyntaxParser() {
        assertTrue(org.coode.owlapi.functionalparser.OWLFunctionalSyntaxParserConstants.class.isAssignableFrom(OWLFunctionalSyntaxParser.class));
    }

    public void verifyOWLFunctionalSyntaxParser() throws ParseException, OWLParserException, UnloadableImportException {
        OWLFunctionalSyntaxParser testSubject0 = new OWLFunctionalSyntaxParser(_InputStream, _String);
        OWLFunctionalSyntaxParser testSubject1 = new OWLFunctionalSyntaxParser(_Reader);
        OWLFunctionalSyntaxParser testSubject2 = new OWLFunctionalSyntaxParser(_InputStream);
        OWLFunctionalSyntaxParser testSubject3 = new OWLFunctionalSyntaxParser(_OWLFunctionalSyntaxParserTokenManager);
        org.semanticweb.owlapi.io.OWLFunctionalSyntaxOntologyFormat result0 = testSubject0.parse();
        OWLImportsDeclaration result1 = testSubject0.ImportsDeclaration();
        int result2 = testSubject0.Integer();
        OWLClass result3 = testSubject0.Class();
        OWLClassExpression result4 = testSubject0.ObjectSomeValuesFrom();
        OWLClassExpression result5 = testSubject0.ObjectAllValuesFrom();
        OWLClassExpression result6 = testSubject0.ObjectMinCardinality();
        OWLClassExpression result7 = testSubject0.ObjectMaxCardinality();
        OWLClassExpression result8 = testSubject0.ObjectExactCardinality();
        OWLClassExpression result9 = testSubject0.ObjectHasValue();
        OWLClassExpression result10 = testSubject0.DataSomeValuesFrom();
        OWLClassExpression result11 = testSubject0.DataAllValuesFrom();
        OWLClassExpression result12 = testSubject0.DataMinCardinality();
        OWLClassExpression result13 = testSubject0.DataMaxCardinality();
        OWLClassExpression result14 = testSubject0.DataExactCardinality();
        OWLClassExpression result15 = testSubject0.DataHasValue();
        OWLClassExpression result16 = testSubject0.ObjectIntersectionOf();
        OWLClassExpression result17 = testSubject0.ObjectUnionOf();
        OWLClassExpression result18 = testSubject0.ObjectComplementOf();
        OWLClassExpression result19 = testSubject0.ObjectOneOf();
        OWLDatatype result20 = testSubject0.Datatype();
        OWLDataRange result21 = testSubject0.DataOneOf();
        OWLDataRange result22 = testSubject0.DataComplementOf();
        OWLDataRange result23 = testSubject0.DataUnionOf();
        OWLDataRange result24 = testSubject0.DataIntersectionOf();
        OWLObjectProperty result25 = testSubject0.ObjectProperty();
        OWLDataProperty result26 = testSubject0.DataProperty();
        OWLAnnotationProperty result27 = testSubject0.AnnotationProperty();
        OWLNamedIndividual result28 = testSubject0.NamedIndividual();
        testSubject0.Ontology();
        OWLAnnotation result29 = testSubject0.Annotation();
        OWLIndividual result30 = testSubject0.Individual();
        OWLLiteral result31 = testSubject0.Literal();
        OWLDataRange result32 = testSubject0.DataRange();
        OWLAxiom result33 = testSubject0.Axiom();
        OWLAxiom result34 = testSubject0.Declaration();
        OWLClassAxiom result35 = testSubject0.EquivalentClasses();
        OWLClassAxiom result36 = testSubject0.SubClassOf();
        OWLClassAxiom result37 = testSubject0.DisjointClasses();
        OWLClassAxiom result38 = testSubject0.DisjointUnion();
        OWLIndividualAxiom result39 = testSubject0.ClassAssertion();
        OWLIndividualAxiom result40 = testSubject0.DifferentIndividuals();
        OWLIndividualAxiom result41 = testSubject0.ObjectPropertyAssertion();
        OWLIndividualAxiom result42 = testSubject0.NegativeObjectPropertyAssertion();
        OWLIndividualAxiom result43 = testSubject0.DataPropertyAssertion();
        OWLIndividualAxiom result44 = testSubject0.NegativeDataPropertyAssertion();
        OWLPropertyAxiom result45 = testSubject0.EquivalentObjectProperties();
        OWLPropertyAxiom result46 = testSubject0.SubObjectPropertyOf();
        OWLPropertyAxiom result47 = testSubject0.InverseObjectProperties();
        OWLPropertyAxiom result48 = testSubject0.FunctionalObjectProperty();
        OWLPropertyAxiom result49 = testSubject0.InverseFunctionalObjectProperty();
        OWLPropertyAxiom result50 = testSubject0.SymmetricObjectProperty();
        OWLPropertyAxiom result51 = testSubject0.AsymmetricObjectProperty();
        OWLPropertyAxiom result52 = testSubject0.TransitiveObjectProperty();
        OWLPropertyAxiom result53 = testSubject0.ReflexiveObjectProperty();
        OWLPropertyAxiom result54 = testSubject0.ObjectPropertyDomain();
        OWLPropertyAxiom result55 = testSubject0.ObjectPropertyRange();
        OWLPropertyAxiom result56 = testSubject0.DisjointObjectProperties();
        OWLPropertyAxiom result57 = testSubject0.EquivalentDataProperties();
        OWLPropertyAxiom result58 = testSubject0.SubDataPropertyOf();
        OWLPropertyAxiom result59 = testSubject0.FunctionalDataProperty();
        OWLPropertyAxiom result60 = testSubject0.DataPropertyDomain();
        OWLPropertyAxiom result61 = testSubject0.DataPropertyRange();
        OWLPropertyAxiom result62 = testSubject0.DisjointDataProperties();
        OWLHasKeyAxiom result63 = testSubject0.HasKey();
        OWLAnnotationAssertionAxiom result64 = testSubject0.AnnotationAssertion();
        OWLSubAnnotationPropertyOfAxiom result65 = testSubject0.SubAnnotationPropertyOf();
        OWLAnnotationPropertyDomainAxiom result66 = testSubject0.AnnotationPropertyDomain();
        IRI result67 = testSubject0.IRI();
        OWLAnonymousIndividual result68 = testSubject0.AnonymousIndividual();
        OWLPropertyAxiom result69 = testSubject0.IrreflexiveObjectProperty();
        OWLAnnotationPropertyRangeAxiom result70 = testSubject0.AnnotationPropertyRange();
        testSubject0.Prefix();
        IRI result71 = testSubject0.AbbreviatedIRI();
        SWRLRule result72 = testSubject0.DLSafeRule();
        SWRLClassAtom result73 = testSubject0.ClassAtom();
        SWRLDataRangeAtom result74 = testSubject0.DataRangeAtom();
        SWRLObjectPropertyAtom result75 = testSubject0.ObjectPropertyAtom();
        SWRLDataPropertyAtom result76 = testSubject0.DataPropertyAtom();
        SWRLBuiltInAtom result77 = testSubject0.BuiltInAtom();
        SWRLSameIndividualAtom result78 = testSubject0.SameIndividualAtom();
        SWRLDifferentIndividualsAtom result79 = testSubject0.DifferentIndividualsAtom();
        ...
        org.coode.owlapi.functionalparser.ParseException result81 = testSubject0.generateParseException();
        ...
        IRI result83 = testSubject0.getIRI(_String);
        testSubject0.setUp(_OWLOntologyManager, _OWLOntology, _OWLOntologyLoaderConfiguration);
        ...
        java.util.Set<OWLClassExpression> result89 = testSubject0.ClassExpressionSet();
        java.util.Set<OWLIndividual> result90 = testSubject0.IndividualMinOneSet();
        ...
        java.util.Set<OWLAnnotation> result101 = testSubject0.AxiomAnnotationSet();
        ...
        java.util.List<OWLObjectPropertyExpression> result109 = testSubject0.SubObjectPropertyChain();
        java.util.Set<OWLObjectPropertyExpression> result110 = testSubject0.ObjectPropertySet();
        java.util.Set<OWLDataPropertyExpression> result111 = testSubject0.DataPropertySet();
        OWLIndividualAxiom result112 = testSubject0.SameIndividuals();
        java.util.Set<OWLIndividual> result113 = testSubject0.IndividualSet();
    ...
    public void enforceInterfacesOWLFunctionalSyntaxParserFactory() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserFactory.class.isAssignableFrom(OWLFunctionalSyntaxParserFactory.class));
    }
    ...
    public void enforceInterfacesOWLFunctionalSyntaxParserTokenManager() {
        assertTrue(org.coode.owlapi.functionalparser.OWLFunctionalSyntaxParserConstants.class.isAssignableFrom(OWLFunctionalSyntaxParserTokenManager.class));
    }
    ...
    public void enforceInterfacesSimpleNode() {
        assertTrue(org.coode.owlapi.functionalparser.Node.class.isAssignableFrom(SimpleNode.class));
    }
