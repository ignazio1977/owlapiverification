...
public class Gen_org_semanticweb_owlapi_reasoner {
    ...
    public void verifyAxiomNotInProfileException()  {
        ...
        org.semanticweb.owlapi.profiles.OWLProfile result1 = testSubject0
                .getProfile();
    ...
    public void verifyFreshEntitiesException()  {
        FreshEntitiesException testSubject0 = new FreshEntitiesException(
                _OWLEntity, _Throwable);
        FreshEntitiesException testSubject1 = new FreshEntitiesException(
                _OWLEntity);
        FreshEntitiesException testSubject2 = new FreshEntitiesException(
                _Collection, _Throwable);
        FreshEntitiesException testSubject3 = new FreshEntitiesException(_Set);
        FreshEntitiesException testSubject4 = new FreshEntitiesException(
                _Collection);
        String result0 = testSubject0.getMessage();
        java.util.List<OWLEntity> result1 = testSubject0
                .getEntities();
        testSubject0.printStackTrace();
        testSubject0.printStackTrace(_PrintWriter);
        testSubject0.printStackTrace(_PrintStream);
    ...
    public void verifyImportsClosureNotInProfileException()  {
        ImportsClosureNotInProfileException testSubject0 = new ImportsClosureNotInProfileException(
                _OWLProfile);
        org.semanticweb.owlapi.profiles.OWLProfile result0 = testSubject0
                .getProfile();
        testSubject0.printStackTrace();
        testSubject0.printStackTrace(_PrintWriter);
        testSubject0.printStackTrace(_PrintStream);
    ...
    public void verifyInterfaceOWLReasoner()  {
        ...
        org.semanticweb.owlapi.util.Version result12 = testSubject0
                .getReasonerVersion();
        ...
        java.util.Set<OWLAxiom> result17 = testSubject0
                .getPendingAxiomRemovals();
        OWLOntology result18 = testSubject0
                .getRootOntology();
        ...
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result23 = testSubject0
        ...
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result27 = testSubject0
                .getTopClassNode();
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result28 = testSubject0
                .getBottomClassNode();
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result29 = testSubject0
                .getTopObjectPropertyNode();
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result30 = testSubject0
                .getBottomObjectPropertyNode();
        org.semanticweb.owlapi.reasoner.NodeSet<OWLObjectPropertyExpression> result31 = testSubject0
                .getSubObjectProperties(_OWLObjectPropertyExpression, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLObjectPropertyExpression> result32 = testSubject0
        ...
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result35 = testSubject0
                .getInverseObjectProperties(_OWLObjectPropertyExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result36 = testSubject0
                .getObjectPropertyDomains(_OWLObjectPropertyExpression,
                        _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result37 = testSubject0
                .getObjectPropertyRanges(_OWLObjectPropertyExpression, _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result38 = testSubject0
                .getTopDataPropertyNode();
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result39 = testSubject0
                .getBottomDataPropertyNode();
        org.semanticweb.owlapi.reasoner.NodeSet<OWLDataProperty> result40 = testSubject0
                .getSubDataProperties(_OWLDataProperty, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLDataProperty> result41 = testSubject0
        ...
        org.semanticweb.owlapi.reasoner.NodeSet<OWLNamedIndividual> result45 = testSubject0
    ...
    public void verifySimpleConfiguration()  {
        ...
        SimpleConfiguration testSubject1 = new SimpleConfiguration(
                _FreshEntityPolicy, _long);
    ...
    public void verifyTimeOutException()  {
        ...
        TimeOutException testSubject2 = new TimeOutException(_String,
                _Throwable);
        testSubject0.printStackTrace();
        testSubject0.printStackTrace(_PrintWriter);
        testSubject0.printStackTrace(_PrintStream);
