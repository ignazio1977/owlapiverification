...
public class Gen_org_obolibrary_macro {
    ...
    public void verifyAbstractMacroExpansionVisitor() {
        AbstractMacroExpansionVisitor testSubject0 = new AbstractMacroExpansionVisitor(_OWLOntology, mock(Logger.class)) {
            @Override
    ...
    public void verifyManchesterSyntaxTool() {
        ...
        java.util.Set<org.coode.owlapi.manchesterowlsyntax.OntologyAxiomPair> result2 = testSubject0.parseManchesterExpressionFrames(_String);
