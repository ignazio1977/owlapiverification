...
public class Gen_com_clarkparsia_owlapi_explanation {
    ...
    public void verifyDefaultExplanationGenerator()  {
        ...
        java.util.Set<java.util.Set<OWLAxiom>> result3 = testSubject0
                .getExplanations(_OWLClassExpression, _int);
        java.util.Set<java.util.Set<OWLAxiom>> result4 = testSubject0
                .getExplanations(_OWLAxiom);
        java.util.Set<java.util.Set<OWLAxiom>> result5 = testSubject0
    ...
    public void verifyHSTExplanationGenerator()  {
        ...
        java.util.Set<java.util.Set<OWLAxiom>> result5 = testSubject0
                .getExplanations(_OWLClassExpression);
        java.util.Set<java.util.Set<OWLAxiom>> result6 = testSubject0
                .getExplanations(_OWLClassExpression, _int);
    ...
    public void verifyInterfaceMultipleExplanationGenerator()  {
        ...
        org.semanticweb.owlapi.reasoner.OWLReasonerFactory result6 = testSubject0
                .getReasonerFactory();
        OWLOntologyManager result7 = testSubject0
                .getOntologyManager();
    }
