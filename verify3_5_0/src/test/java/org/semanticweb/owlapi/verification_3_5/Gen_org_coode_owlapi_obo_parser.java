...
public class Gen_org_coode_owlapi_obo_parser {
    ...
    public void enforceInterfacesAbstractTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.TagValueHandler.class.isAssignableFrom(AbstractTagValueHandler.class));
    }

    public void verifyAbstractTagValueHandler() {
        AbstractTagValueHandler testSubject0 = new AbstractTagValueHandler(_String, _OBOConsumer) {
            @Override
            public void handle(String currentId, String value, String qualifierBlock, String comment) {
            }
        };
        OWLClass result0 = testSubject0.getCurrentClass();
        String result1 = testSubject0.getTagName();
        org.coode.owlapi.obo.parser.OBOConsumer result2 = testSubject0.getConsumer();
        IRI result3 = testSubject0.getTagIRI(_String);
        IRI result4 = testSubject0.getTagIRI(_OBOVocabulary);
        IRI result5 = testSubject0.getIRIFromOBOId(_String);
        OWLAnnotation result6 = testSubject0.getAnnotationForTagValuePair(_String, _String);
        OWLClass result7 = testSubject0.getClassFromId(_String);
    ...
    public void enforceInterfacesAltIdTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(AltIdTagValueHandler.class));
    }
    ...
    public void enforceInterfacesAsymmetricHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(AsymmetricHandler.class));
    }
    ...
    public void enforceInterfacesDataVersionTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(DataVersionTagValueHandler.class));
    }

    public void verifyDataVersionTagValueHandler() {
        DataVersionTagValueHandler testSubject0 = new DataVersionTagValueHandler(_OBOConsumer);
        testSubject0.handle(_String, _String, _String, _String);
        OWLClass result0 = testSubject0.getCurrentClass();
        String result1 = testSubject0.getTagName();
        org.coode.owlapi.obo.parser.OBOConsumer result2 = testSubject0.getConsumer();
    ...
    public void enforceInterfacesDefaultNamespaceTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(DefaultNamespaceTagValueHandler.class));
    }

    public void verifyDefaultNamespaceTagValueHandler() {
        DefaultNamespaceTagValueHandler testSubject0 = new DefaultNamespaceTagValueHandler(_OBOConsumer);
        testSubject0.handle(_String, _String, _String, _String);
        OWLClass result0 = testSubject0.getCurrentClass();
        String result1 = testSubject0.getTagName();
        org.coode.owlapi.obo.parser.OBOConsumer result2 = testSubject0.getConsumer();
    ...
    public void enforceInterfacesDefTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(DefTagValueHandler.class));
    }
    ...
    public void enforceInterfacesDisjointFromHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(DisjointFromHandler.class));
    }
    ...
    public void enforceInterfacesDomainHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(DomainHandler.class));
    }
    ...
    public void enforceInterfacesIDSpaceTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(IDSpaceTagValueHandler.class));
    }
    ...
    public void enforceInterfacesIDTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(IDTagValueHandler.class));
    }
    ...
    public void enforceInterfacesIntersectionOfHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(IntersectionOfHandler.class));
    }
    ...
    public void enforceInterfacesInverseHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(InverseHandler.class));
    }
    ...
    public void enforceInterfacesIsATagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(IsATagValueHandler.class));
    }
    ...
    public void enforceInterfacesIsObsoleteTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(IsObsoleteTagValueHandler.class));
    }

    public void verifyIsObsoleteTagValueHandler() {
        IsObsoleteTagValueHandler testSubject0 = new IsObsoleteTagValueHandler(_OBOConsumer);
        testSubject0.handle(_String, _String, _String, _String);
        OWLClass result0 = testSubject0.getCurrentClass();
        String result1 = testSubject0.getTagName();
        org.coode.owlapi.obo.parser.OBOConsumer result2 = testSubject0.getConsumer();
    ...
    public void enforceInterfacesNameTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(NameTagValueHandler.class));
    }
    ...
    public void enforceInterfacesOBOConsumer() {
        assertTrue(org.coode.owlapi.obo.parser.OBOParserHandler.class.isAssignableFrom(OBOConsumer.class));
    }

    public void verifyOBOConsumer() {
        OBOConsumer testSubject0 = new OBOConsumer(_OWLOntologyManager, _OWLOntology, _OWLOntologyLoaderConfiguration, _IRI);
        OBOConsumer testSubject1 = new OBOConsumer(_OWLOntology, _OWLOntologyLoaderConfiguration, _IRI);
        OWLClass result0 = testSubject0.getCurrentClass();
        IRI result1 = testSubject0.getIRIFromTagName(_String);
        IRI result2 = testSubject0.getIRIFromOBOId(_String);
        String result3 = testSubject0.getCurrentId();
        IRI result4 = testSubject0.getRelationIRIFromSymbolicIdOrOBOId(_String);
        ...
        org.coode.owlapi.obo.parser.IDSpaceManager result6 = testSubject0.getIdSpaceManager();
        ...
        OWLEntity result12 = testSubject0.getCurrentEntity();
        OWLAnnotation result13 = testSubject0.parseXRef(_String);
        OWLOntology result14 = testSubject0.getOntology();
        OWLOntologyManager result15 = testSubject0.getOWLOntologyManager();
    }
    ...
    public void verifyOBOFrame() {
        ...
        java.util.List<org.coode.owlapi.obo.parser.OBOTagValuePair> result1 = testSubject0.getTagValuePairs();
    ...
    public void verifyOBOIdTranslator() {
        ...
        IRI result0 = testSubject0.getIRIFromOBOId(_String);
    ...
    public void verifyEnumOBOIdType() {
        ...
        IRI result0 = testSubject0.getIRIFromOBOId(_OWLOntologyID, _IDSpaceManager, _String);
    ...
    public void verifyOBOOntologyFormat() {
        ...
        org.coode.owlapi.obo.parser.IDSpaceManager result0 = testSubject0.getIdSpaceManager();
        ...
        org.semanticweb.owlapi.vocab.PrefixOWLOntologyFormat result3 = testSubject0.asPrefixOWLOntologyFormat();
    ...
    public void enforceInterfacesOBOParser() {
        assertTrue(org.coode.owlapi.obo.parser.OBOParserConstants.class.isAssignableFrom(OBOParser.class));
    }

    public void verifyOBOParser() throws ParseException {
        ...
        org.coode.owlapi.obo.parser.ParseException result2 = testSubject0.generateParseException();
    ...
    public void enforceInterfacesOBOParserException() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserException.class.isAssignableFrom(OBOParserException.class));
    }
    ...
    public void enforceInterfacesOBOParserFactory() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserFactory.class.isAssignableFrom(OBOParserFactory.class));
    }
    ...
    public void enforceInterfacesOBOParserHandlerAdapter() {
        assertTrue(org.coode.owlapi.obo.parser.OBOParserHandler.class.isAssignableFrom(OBOParserHandlerAdapter.class));
    }
    ...
    public void enforceInterfacesOBOParserTokenManager() {
        assertTrue(org.coode.owlapi.obo.parser.OBOParserConstants.class.isAssignableFrom(OBOParserTokenManager.class));
    }
    ...
    public void verifyOBOTagValuePair() {
        OBOTagValuePair testSubject0 = new OBOTagValuePair(_String, _String, _String, _String);
    ...
    public void verifyEnumOBOVocabulary() {
        ...
        IRI result1 = OBOVocabulary.ID2IRI(_String, _IDSpaceManager);
        IRI result2 = OBOVocabulary.ID2IRI(_String);
        String result3 = OBOVocabulary.IRI2ID(_IRI);
        boolean result4 = OBOVocabulary.isOBOIRI(_IRI);
        java.util.List<org.coode.owlapi.obo.parser.OBOVocabulary> result5 = OBOVocabulary.getHeaderTags();
        java.util.List<org.coode.owlapi.obo.parser.OBOVocabulary> result6 = OBOVocabulary.getTermStanzaTags();
        java.util.List<org.coode.owlapi.obo.parser.OBOVocabulary> result7 = OBOVocabulary.getTypeDefStanzaTags();
        java.util.List<org.coode.owlapi.obo.parser.OBOVocabulary> result8 = OBOVocabulary.getInstanceStanzaTags();
        IRI result9 = testSubject0.getIRI();
    }

    @Test
    public void enforceInterfacesOntologyTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(OntologyTagValueHandler.class));
    }
    ...
    public void enforceInterfacesOWLOBOParser() {
        assertTrue(org.semanticweb.owlapi.io.AbstractOWLParser.class.isAssignableFrom(OWLOBOParser.class));
    }

    public void verifyOWLOBOParser() throws OWLParserException, OWLOntologyChangeException, UnloadableImportException, IOException {
    ...
    public void verifyParseException() {
        ...
        ParseException testSubject2 = new ParseException(_Token, _int_array_array, _String_array);
        testSubject0.printStackTrace();
        testSubject0.printStackTrace(_PrintWriter);
        testSubject0.printStackTrace(_PrintStream);
    ...
    public void enforceInterfacesPartOfTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(PartOfTagValueHandler.class));
    }
    ...
    public void enforceInterfacesRawFrameHandler() {
        assertTrue(org.coode.owlapi.obo.parser.OBOParserHandler.class.isAssignableFrom(RawFrameHandler.class));
    }
    ...
    public void verifyRawFrameHandler() {
        ...
        testSubject0.endFrame();
        testSubject0.handleTagValue(_String, _String, _String, _String);
        java.util.List<org.coode.owlapi.obo.parser.OBOFrame> result0 = testSubject0.getTypeDefFrames();
        java.util.List<org.coode.owlapi.obo.parser.OBOFrame> result1 = testSubject0.getNonTypeDefFrames();
        org.coode.owlapi.obo.parser.OBOFrame result2 = testSubject0.getHeaderFrame();
    }

    @Test
    public void enforceInterfacesReflexiveHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(ReflexiveHandler.class));
    }
    ...
    public void enforceInterfacesRelationshipTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(RelationshipTagValueHandler.class));
    }

    public void verifyRelationshipTagValueHandler() {
        RelationshipTagValueHandler testSubject0 = new RelationshipTagValueHandler(_OBOConsumer);
        testSubject0.handle(_String, _String, _String, _String);
        OWLClass result0 = testSubject0.getCurrentClass();
        String result1 = testSubject0.getTagName();
        org.coode.owlapi.obo.parser.OBOConsumer result2 = testSubject0.getConsumer();
    ...
    public void enforceInterfacesSymmetricTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(SymmetricTagValueHandler.class));
    }
    ...
    public void enforceInterfacesSynonymTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(SynonymTagValueHandler.class));
    }
    ...
    public void enforceInterfacesSynonymTypeDefTagHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(SynonymTypeDefTagHandler.class));
    }
    ...
    public void enforceInterfacesTokenMgrError() {
        assertTrue(OWLRuntimeException.class.isAssignableFrom(TokenMgrError.class));
    }

    public void verifyTokenMgrError() {
        TokenMgrError testSubject0 = new TokenMgrError(_String, _int);
        TokenMgrError testSubject1 = new TokenMgrError(_boolean, _int, _int, _int, _String, _char, _int);
    ...
    public void enforceInterfacesTransitiveOverHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(TransitiveOverHandler.class));
    }
    ...
    public void enforceInterfacesTransitiveTagValueHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(TransitiveTagValueHandler.class));
    }

    public void verifyTransitiveTagValueHandler() {
        TransitiveTagValueHandler testSubject0 = new TransitiveTagValueHandler(_OBOConsumer);
        testSubject0.handle(_String, _String, _String, _String);
        OWLClass result0 = testSubject0.getCurrentClass();
        String result1 = testSubject0.getTagName();
        org.coode.owlapi.obo.parser.OBOConsumer result2 = testSubject0.getConsumer();
    ...
    public void enforceInterfacesUnionOfHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(UnionOfHandler.class));
    }
    ...
    public void enforceInterfacesXRefTagHandler() {
        assertTrue(org.coode.owlapi.obo.parser.AbstractTagValueHandler.class.isAssignableFrom(XRefTagHandler.class));
    }
