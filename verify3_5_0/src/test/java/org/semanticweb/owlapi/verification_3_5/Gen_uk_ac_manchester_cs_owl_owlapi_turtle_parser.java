...
public class Gen_uk_ac_manchester_cs_owl_owlapi_turtle_parser {
    ...
    public void enforceInterfacesConsoleTripleHandler() {
        assertTrue(uk.ac.manchester.cs.owl.owlapi.turtle.parser.TripleHandler.class.isAssignableFrom(ConsoleTripleHandler.class));
    }
    ...
    public void enforceInterfacesNullTripleHandler() {
        assertTrue(uk.ac.manchester.cs.owl.owlapi.turtle.parser.TripleHandler.class.isAssignableFrom(NullTripleHandler.class));
    }
    ...
    public void enforceInterfacesOWLRDFConsumerAdapter() {
        assertTrue(org.coode.owlapi.rdfxml.parser.OWLRDFConsumer.class.isAssignableFrom(OWLRDFConsumerAdapter.class));
        assertTrue(uk.ac.manchester.cs.owl.owlapi.turtle.parser.TripleHandler.class.isAssignableFrom(OWLRDFConsumerAdapter.class));
    }

    public void verifyOWLRDFConsumerAdapter() throws SAXException, UnloadableImportException {
        OWLRDFConsumerAdapter testSubject0 = new OWLRDFConsumerAdapter(_OWLOntologyManager, _OWLOntology, _AnonymousNodeChecker, _OWLOntologyLoaderConfiguration);
        OWLRDFConsumerAdapter testSubject1 = new OWLRDFConsumerAdapter(_OWLOntology, _AnonymousNodeChecker, _OWLOntologyLoaderConfiguration);
        testSubject0.handlePrefixDirective(_String, _String);
        testSubject0.handleBaseDirective(_String);
        testSubject0.handleComment(_String);
        testSubject0.handleEnd();
    ...
    public void verifyToken() {
        ...
        uk.ac.manchester.cs.owl.owlapi.turtle.parser.Token result1 = Token.newToken(_int, _String);
    ...
    public void verifyTurtleOntologyParser() throws OWLParserException, UnloadableImportException, IOException {
    ...
    public void enforceInterfacesTurtleOntologyParserFactory() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserFactory.class.isAssignableFrom(TurtleOntologyParserFactory.class));
    }
    ...
    public void enforceInterfacesTurtleParser() {
        assertTrue(org.coode.owlapi.rdfxml.parser.AnonymousNodeChecker.class.isAssignableFrom(TurtleParser.class));
        assertTrue(uk.ac.manchester.cs.owl.owlapi.turtle.parser.TurtleParserConstants.class.isAssignableFrom(TurtleParser.class));
    }

    public void verifyTurtleParser() throws ParseException {
        ...
        IRI result5 = testSubject0.parseBlankNode();
        IRI result6 = testSubject0.parseLoneNS();
        IRI result7 = testSubject0.parseAbbreviatedIRI();
        IRI result8 = testSubject0.parseNodeID();
        IRI result9 = testSubject0.parseCollection();
        IRI result10 = testSubject0.parseVerb();
        testSubject0.parseObjectList(_IRI, _IRI);
        IRI result11 = testSubject0.parsePredicate();
        IRI result12 = testSubject0.parseItemList();
        ...
        uk.ac.manchester.cs.owl.owlapi.turtle.parser.Token result17 = testSubject0.getNextToken();
        uk.ac.manchester.cs.owl.owlapi.turtle.parser.ParseException result18 = testSubject0.generateParseException();
        uk.ac.manchester.cs.owl.owlapi.turtle.parser.Token result19 = testSubject0.getToken(_int);
        testSubject0.enable_tracing();
        testSubject0.disable_tracing();
        IRI result23 = testSubject0.getIRI(_String);
    ...
    public void enforceInterfacesTurtleParserException() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserException.class.isAssignableFrom(TurtleParserException.class));
    }

    public void verifyTurtleParserException() {
        TurtleParserException testSubject0 = new TurtleParserException(_String);
        TurtleParserException testSubject1 = new TurtleParserException(_String, _Throwable);
    ...
    public void enforceInterfacesTurtleParserTokenManager() {
        assertTrue(uk.ac.manchester.cs.owl.owlapi.turtle.parser.TurtleParserConstants.class.isAssignableFrom(TurtleParserTokenManager.class));
    }
