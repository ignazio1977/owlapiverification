...
public class Gen_org_coode_owlapi_turtle {
    ...
    public void enforceInterfacesTurtleOntologyFormat() {
        assertTrue(org.semanticweb.owlapi.io.RDFOntologyFormat.class.isAssignableFrom(TurtleOntologyFormat.class));
    }
    ...
    public void enforceInterfacesTurtleRenderer() {
        assertTrue(org.coode.owlapi.rdf.renderer.RDFRendererBase.class.isAssignableFrom(TurtleRenderer.class));
    }

    public void verifyTurtleRenderer() throws IOException {
        TurtleRenderer testSubject0 = new TurtleRenderer(_OWLOntology, _OWLOntologyManager, _Writer, _OWLOntologyFormat);
        TurtleRenderer testSubject1 = new TurtleRenderer(_OWLOntology, _Writer, _OWLOntologyFormat);
