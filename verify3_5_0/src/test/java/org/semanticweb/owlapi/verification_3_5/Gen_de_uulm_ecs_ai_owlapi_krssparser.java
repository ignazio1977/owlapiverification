...
public class Gen_de_uulm_ecs_ai_owlapi_krssparser {
    ...
    public void verifyKRSS2OWLParser() throws OWLParserException, UnloadableImportException, IOException {
    ...
    public void enforceInterfacesKRSS2OWLParserException() {
        assertTrue(org.coode.owl.krssparser.KRSSOWLParserException.class.isAssignableFrom(KRSS2OWLParserException.class));
    }

    public void verifyKRSS2OWLParserException() {
        KRSS2OWLParserException testSubject0 = new KRSS2OWLParserException(_ParseException);
    ...
    public void enforceInterfacesKRSS2OWLParserFactory() {
        assertTrue(org.semanticweb.owlapi.io.OWLParserFactory.class.isAssignableFrom(KRSS2OWLParserFactory.class));
    }
    ...
    public void enforceInterfacesKRSS2Parser() {
        assertTrue(de.uulm.ecs.ai.owlapi.krssparser.KRSS2ParserConstants.class.isAssignableFrom(KRSS2Parser.class));
    }

    public void verifyKRSS2Parser() throws KRSS2OWLParserException, ParseException, URISyntaxException {
        ...
        java.util.List<OWLObjectPropertyExpression> result3 = testSubject0.propertyChain();
        ...
        OWLClassExpression result4 = testSubject0.ConceptName();
        OWLClassExpression result5 = testSubject0.ConceptExpression();
        OWLObjectPropertyExpression result6 = testSubject0.RoleExpression();
        OWLObjectProperty result7 = testSubject0.RoleName();
        ...
        java.util.Set<OWLObjectProperty> result8 = testSubject0.RoleNameSet();
        OWLClassExpression result9 = testSubject0.And();
        OWLClassExpression result10 = testSubject0.Or();
        OWLClassExpression result11 = testSubject0.Not();
        OWLClassExpression result12 = testSubject0.Some();
        OWLClassExpression result13 = testSubject0.AtLeast();
        OWLClassExpression result14 = testSubject0.AtMost();
        OWLClassExpression result15 = testSubject0.Exactly();
        java.util.Set<OWLClassExpression> result16 = testSubject0.ConceptSet();
        testSubject0.Instance();
        testSubject0.Related();
        testSubject0.Equal();
        testSubject0.Distinct();
        OWLIndividual result17 = testSubject0.IndividualName();
        de.uulm.ecs.ai.owlapi.krssparser.Token result18 = testSubject0.getNextToken();
        de.uulm.ecs.ai.owlapi.krssparser.ParseException result19 = testSubject0.generateParseException();
        ...
        IRI result21 = testSubject0.getIRI(_String);
        OWLClassExpression result22 = testSubject0.All();
    }
    ...
    public void enforceInterfacesKRSS2ParserTokenManager() {
        assertTrue(de.uulm.ecs.ai.owlapi.krssparser.KRSS2ParserConstants.class.isAssignableFrom(KRSS2ParserTokenManager.class));
    }
