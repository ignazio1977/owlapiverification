...
import AxiomType;
import ClassExpressionType;
import OWLAnnotation;
import OWLAnnotationProperty;
import OWLAnonymousIndividual;
import OWLAxiom;
import OWLAxiomVisitor;
import OWLAxiomVisitorEx;
import OWLClass;
import OWLClassAxiom;
import OWLClassExpression;
import OWLClassExpressionVisitor;
import OWLClassExpressionVisitorEx;
import OWLDataProperty;
import OWLDataPropertyExpression;
import OWLDataRange;
import OWLDatatype;
import OWLEntity;
import OWLIndividual;
import OWLIndividualVisitor;
import OWLIndividualVisitorEx;
import OWLLiteral;
...
import OWLObjectVisitor;
import OWLObjectVisitorEx;
import OWLOntology;
import OWLOntologyCreationException;
import OWLOntologyLoaderConfiguration;
import OWLPropertyExpression;
import OWLPropertyExpressionVisitor;
import OWLPropertyExpressionVisitorEx;
import OWLPropertyRange;
import OWLSubClassOfAxiom;
import OWLSubPropertyAxiom;
import SWRLArgument;
import SWRLDArgument;
import SWRLIArgument;
import SWRLObjectVisitor;
import SWRLObjectVisitorEx;
...
public class Gen_uk_ac_manchester_cs_owl_owlapi {
    ...
    public void enforceInterfacesAbstractInMemOWLOntologyFactory()
             {
        assertTrue(OWLOntologyFactory.class
                .isAssignableFrom(AbstractInMemOWLOntologyFactory.class));
    }

    public void verifyAbstractInMemOWLOntologyFactory()  {
    ...
    public void verifyAbstractInternalsImpl()  {
        ...
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLClassAxiom> result1 = testSubject0
                .getClassAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLSubClassOfAxiom> result2 = testSubject0
        ...
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLSubClassOfAxiom> result5 = testSubject0
                .getSubClassAxiomsByRHS();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result6 = testSubject0
                .getEquivalentClassesAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLEquivalentClassesAxiom> result7 = testSubject0
                .getEquivalentClassesAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result8 = testSubject0
                .getDisjointClassesAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLDisjointClassesAxiom> result9 = testSubject0
                .getDisjointClassesAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result10 = testSubject0
                .getDisjointUnionAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLDisjointUnionAxiom> result11 = testSubject0
                .getDisjointUnionAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLHasKeyAxiom> result12 = testSubject0
                .getHasKeyAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result13 = testSubject0
                .getHasKeyAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLSubObjectPropertyOfAxiom> result14 = testSubject0
        ...
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLSubObjectPropertyOfAxiom> result17 = testSubject0
                .getObjectSubPropertyAxiomsByRHS();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result21 = testSubject0
                .getDisjointObjectPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLObjectPropertyDomainAxiom> result22 = testSubject0
                .getObjectPropertyDomainAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result23 = testSubject0
                .getObjectPropertyDomainAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLObjectPropertyRangeAxiom> result24 = testSubject0
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result29 = testSubject0
                .getInverseFunctionalPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLSymmetricObjectPropertyAxiom> result30 = testSubject0
                .getSymmetricPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result31 = testSubject0
                .getSymmetricPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLAsymmetricObjectPropertyAxiom> result32 = testSubject0
                .getAsymmetricPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result33 = testSubject0
                .getAsymmetricPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLReflexiveObjectPropertyAxiom> result34 = testSubject0
                .getReflexivePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result35 = testSubject0
                .getReflexivePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLIrreflexiveObjectPropertyAxiom> result36 = testSubject0
        ...
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLTransitiveObjectPropertyAxiom> result39 = testSubject0
                .getTransitivePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result40 = testSubject0
                .getInversePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLInverseObjectPropertiesAxiom> result41 = testSubject0
                .getInversePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result42 = testSubject0
                .getDataSubPropertyAxiomsByLHS();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLSubDataPropertyOfAxiom> result43 = testSubject0
                .getDataSubPropertyAxiomsByLHS();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLSubDataPropertyOfAxiom> result44 = testSubject0
        ...
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLEquivalentDataPropertiesAxiom> result47 = testSubject0
                .getEquivalentDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result48 = testSubject0
                .getDisjointDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLDisjointDataPropertiesAxiom> result49 = testSubject0
                .getDisjointDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLDataPropertyDomainAxiom> result50 = testSubject0
                .getDataPropertyDomainAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result51 = testSubject0
                .getDataPropertyDomainAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLDataPropertyRangeAxiom> result52 = testSubject0
        ...
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLFunctionalDataPropertyAxiom> result55 = testSubject0
                .getFunctionalDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result56 = testSubject0
                .getClassAssertionAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLClassAssertionAxiom> result57 = testSubject0
                .getClassAssertionAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result58 = testSubject0
                .getClassAssertionAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClassExpression, OWLClassAssertionAxiom> result59 = testSubject0
                .getClassAssertionAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLObjectPropertyAssertionAxiom> result60 = testSubject0
        ...
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLDataPropertyAssertionAxiom> result63 = testSubject0
                .getDataPropertyAssertionsByIndividual();
        ...
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLDifferentIndividualsAxiom> result69 = testSubject0
                .getDifferentIndividualsAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLSameIndividualAxiom> result70 = testSubject0
                .getSameIndividualsAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result71 = testSubject0
                .getSameIndividualsAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLAnnotationSubject, OWLAnnotationAssertionAxiom> result72 = testSubject0
        ...
        java.util.Set<OWLAxiom> result79 = testSubject0.getValues(_Pointer,
                _Object);
        Pointer<AxiomType<?>, OWLAxiom> result80 = testSubject0
                .getAxiomsByType();
        testSubject0.addGeneralClassAxioms(_OWLClassAxiom);
        boolean result81 = testSubject0
                .addImportsDeclaration(_OWLImportsDeclaration);
        boolean result82 = testSubject0.addOntologyAnnotation(_OWLAnnotation);
        testSubject0
                .addPropertyChainSubPropertyAxioms(_OWLSubPropertyChainOfAxiom);
        Pointer<OWLEntity, OWLDeclarationAxiom> result83 = testSubject0
                .getDeclarationsByEntity();
        java.util.Set<OWLAnnotation> result84 = testSubject0
                .getOntologyAnnotations();
        Pointer<OWLAnnotationProperty, OWLAxiom> result85 = testSubject0
                .getOwlAnnotationPropertyReferences();
        Pointer<OWLAnonymousIndividual, OWLAxiom> result86 = testSubject0
                .getOwlAnonymousIndividualReferences();
        Pointer<OWLClass, OWLAxiom> result87 = testSubject0
                .getOwlClassReferences();
        Pointer<OWLDataProperty, OWLAxiom> result88 = testSubject0
                .getOwlDataPropertyReferences();
        Pointer<OWLDatatype, OWLAxiom> result89 = testSubject0
                .getOwlDatatypeReferences();
        Pointer<OWLNamedIndividual, OWLAxiom> result90 = testSubject0
                .getOwlIndividualReferences();
        Pointer<OWLObjectProperty, OWLAxiom> result91 = testSubject0
        ...
        boolean result95 = testSubject0
                .removeImportsDeclaration(_OWLImportsDeclaration);
        boolean result96 = testSubject0
                .removeOntologyAnnotation(_OWLAnnotation);
        testSubject0
                .removePropertyChainSubPropertyAxioms(_OWLSubPropertyChainOfAxiom);
        java.util.Set<OWLImportsDeclaration> result97 = testSubject0
                .getImportsDeclarations();
        java.util.Set<OWLAxiom> result98 = testSubject0
                .getAxioms();
        int result99 = testSubject0.getAxiomCount(_AxiomType);
        int result100 = testSubject0.getAxiomCount();
        java.util.Set<OWLLogicalAxiom> result101 = testSubject0
                .getLogicalAxioms();
        int result102 = testSubject0.getLogicalAxiomCount();
        java.util.Set<OWLClassAxiom> result103 = testSubject0
    ...
    public void verifyImplUtils()  {
        ...
        java.util.Set<OWLAnnotation> result0 = ImplUtils
                .getAnnotations(_OWLEntity, _OWLAnnotationProperty, _Set);
        java.util.Set<OWLAnnotation> result1 = ImplUtils
                .getAnnotations(_OWLEntity, _Set);
        java.util.Set<OWLAnnotationAssertionAxiom> result2 = ImplUtils
    ...
    public void verifyInterfaceInternals()  {
        ...
        java.util.Set<OWLAxiom> result5 = testSubject0.getValues(_Pointer,
                _Object);
        Pointer<OWLClass, OWLClassAxiom> result6 = testSubject0
                .getClassAxiomsByClass();
        Pointer<OWLClass, OWLSubClassOfAxiom> result7 = testSubject0
                .getSubClassAxiomsByLHS();
        Pointer<OWLClass, OWLSubClassOfAxiom> result8 = testSubject0
                .getSubClassAxiomsByRHS();
        Pointer<OWLClass, OWLEquivalentClassesAxiom> result9 = testSubject0
                .getEquivalentClassesAxiomsByClass();
        Pointer<OWLClass, OWLDisjointClassesAxiom> result10 = testSubject0
                .getDisjointClassesAxiomsByClass();
        Pointer<OWLClass, OWLDisjointUnionAxiom> result11 = testSubject0
                .getDisjointUnionAxiomsByClass();
        Pointer<OWLClass, OWLHasKeyAxiom> result12 = testSubject0
                .getHasKeyAxiomsByClass();
        Pointer<OWLObjectPropertyExpression, OWLSubObjectPropertyOfAxiom> result13 = testSubject0
                .getObjectSubPropertyAxiomsByLHS();
        Pointer<OWLObjectPropertyExpression, OWLSubObjectPropertyOfAxiom> result14 = testSubject0
                .getObjectSubPropertyAxiomsByRHS();
        Pointer<OWLObjectPropertyExpression, OWLEquivalentObjectPropertiesAxiom> result15 = testSubject0
                .getEquivalentObjectPropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLDisjointObjectPropertiesAxiom> result16 = testSubject0
                .getDisjointObjectPropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLObjectPropertyDomainAxiom> result17 = testSubject0
                .getObjectPropertyDomainAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLObjectPropertyRangeAxiom> result18 = testSubject0
                .getObjectPropertyRangeAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLFunctionalObjectPropertyAxiom> result19 = testSubject0
                .getFunctionalObjectPropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLInverseFunctionalObjectPropertyAxiom> result20 = testSubject0
                .getInverseFunctionalPropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLSymmetricObjectPropertyAxiom> result21 = testSubject0
                .getSymmetricPropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLAsymmetricObjectPropertyAxiom> result22 = testSubject0
                .getAsymmetricPropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLReflexiveObjectPropertyAxiom> result23 = testSubject0
                .getReflexivePropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLIrreflexiveObjectPropertyAxiom> result24 = testSubject0
                .getIrreflexivePropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLTransitiveObjectPropertyAxiom> result25 = testSubject0
                .getTransitivePropertyAxiomsByProperty();
        Pointer<OWLObjectPropertyExpression, OWLInverseObjectPropertiesAxiom> result26 = testSubject0
                .getInversePropertyAxiomsByProperty();
        Pointer<OWLDataPropertyExpression, OWLSubDataPropertyOfAxiom> result27 = testSubject0
                .getDataSubPropertyAxiomsByLHS();
        Pointer<OWLDataPropertyExpression, OWLSubDataPropertyOfAxiom> result28 = testSubject0
                .getDataSubPropertyAxiomsByRHS();
        Pointer<OWLDataPropertyExpression, OWLEquivalentDataPropertiesAxiom> result29 = testSubject0
                .getEquivalentDataPropertyAxiomsByProperty();
        Pointer<OWLDataPropertyExpression, OWLDisjointDataPropertiesAxiom> result30 = testSubject0
                .getDisjointDataPropertyAxiomsByProperty();
        Pointer<OWLDataPropertyExpression, OWLDataPropertyDomainAxiom> result31 = testSubject0
                .getDataPropertyDomainAxiomsByProperty();
        Pointer<OWLDataPropertyExpression, OWLDataPropertyRangeAxiom> result32 = testSubject0
                .getDataPropertyRangeAxiomsByProperty();
        Pointer<OWLDataPropertyExpression, OWLFunctionalDataPropertyAxiom> result33 = testSubject0
                .getFunctionalDataPropertyAxiomsByProperty();
        Pointer<OWLIndividual, OWLClassAssertionAxiom> result34 = testSubject0
                .getClassAssertionAxiomsByIndividual();
        Pointer<OWLClassExpression, OWLClassAssertionAxiom> result35 = testSubject0
                .getClassAssertionAxiomsByClass();
        Pointer<OWLIndividual, OWLObjectPropertyAssertionAxiom> result36 = testSubject0
                .getObjectPropertyAssertionsByIndividual();
        Pointer<OWLIndividual, OWLDataPropertyAssertionAxiom> result37 = testSubject0
                .getDataPropertyAssertionsByIndividual();
        Pointer<OWLIndividual, OWLNegativeObjectPropertyAssertionAxiom> result38 = testSubject0
                .getNegativeObjectPropertyAssertionAxiomsByIndividual();
        Pointer<OWLIndividual, OWLNegativeDataPropertyAssertionAxiom> result39 = testSubject0
                .getNegativeDataPropertyAssertionAxiomsByIndividual();
        Pointer<OWLIndividual, OWLDifferentIndividualsAxiom> result40 = testSubject0
                .getDifferentIndividualsAxiomsByIndividual();
        Pointer<OWLIndividual, OWLSameIndividualAxiom> result41 = testSubject0
                .getSameIndividualsAxiomsByIndividual();
        Pointer<OWLAnnotationSubject, OWLAnnotationAssertionAxiom> result42 = testSubject0
                .getAnnotationAssertionAxiomsBySubject();
        Pointer<AxiomType<?>, OWLAxiom> result43 = testSubject0
                .getAxiomsByType();
        testSubject0.addGeneralClassAxioms(_OWLClassAxiom);
        ...
        testSubject0
                .addPropertyChainSubPropertyAxioms(_OWLSubPropertyChainOfAxiom);
        Pointer<OWLEntity, OWLDeclarationAxiom> result46 = testSubject0
                .getDeclarationsByEntity();
        java.util.Set<OWLAnnotation> result47 = testSubject0
                .getOntologyAnnotations();
        Pointer<OWLAnnotationProperty, OWLAxiom> result48 = testSubject0
                .getOwlAnnotationPropertyReferences();
        Pointer<OWLAnonymousIndividual, OWLAxiom> result49 = testSubject0
                .getOwlAnonymousIndividualReferences();
        Pointer<OWLClass, OWLAxiom> result50 = testSubject0
                .getOwlClassReferences();
        Pointer<OWLDataProperty, OWLAxiom> result51 = testSubject0
                .getOwlDataPropertyReferences();
        Pointer<OWLDatatype, OWLAxiom> result52 = testSubject0
                .getOwlDatatypeReferences();
        Pointer<OWLNamedIndividual, OWLAxiom> result53 = testSubject0
                .getOwlIndividualReferences();
        Pointer<OWLObjectProperty, OWLAxiom> result54 = testSubject0
                .getOwlObjectPropertyReferences();
        ...
        testSubject0
                .removePropertyChainSubPropertyAxioms(_OWLSubPropertyChainOfAxiom);
        java.util.Set<OWLImportsDeclaration> result60 = testSubject0
                .getImportsDeclarations();
        java.util.Set<OWLAxiom> result61 = testSubject0
                .getAxioms();
        int result62 = testSubject0.getAxiomCount(_AxiomType);
        int result63 = testSubject0.getAxiomCount();
        java.util.Set<OWLLogicalAxiom> result64 = testSubject0
                .getLogicalAxioms();
        int result65 = testSubject0.getLogicalAxiomCount();
        java.util.Set<OWLClassAxiom> result66 = testSubject0
                .getGeneralClassAxioms();
    ...
    public void verifyInternalsImpl()  {
        ...
        java.util.Set<OWLAxiom> result5 = testSubject0.getValues(_Pointer,
                _Object);
        uk.ac.manchester.cs.owl.owlapi.MapPointer<AxiomType<?>, OWLAxiom> result6 = testSubject0
                .getAxiomsByType();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result10 = testSubject0
                .getDeclarationsByEntity();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLEntity, OWLDeclarationAxiom> result11 = testSubject0
                .getDeclarationsByEntity();
        java.util.Set<OWLAnnotation> result12 = testSubject0
                .getOntologyAnnotations();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLAnnotationProperty, OWLAxiom> result13 = testSubject0
                .getOwlAnnotationPropertyReferences();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result14 = testSubject0
                .getOwlAnnotationPropertyReferences();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLAnonymousIndividual, OWLAxiom> result15 = testSubject0
                .getOwlAnonymousIndividualReferences();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result16 = testSubject0
                .getOwlAnonymousIndividualReferences();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result17 = testSubject0
                .getOwlClassReferences();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLAxiom> result18 = testSubject0
                .getOwlClassReferences();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataProperty, OWLAxiom> result19 = testSubject0
                .getOwlDataPropertyReferences();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result20 = testSubject0
                .getOwlDataPropertyReferences();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result21 = testSubject0
                .getOwlDatatypeReferences();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDatatype, OWLAxiom> result22 = testSubject0
                .getOwlDatatypeReferences();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result23 = testSubject0
                .getOwlIndividualReferences();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLNamedIndividual, OWLAxiom> result24 = testSubject0
                .getOwlIndividualReferences();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result25 = testSubject0
                .getOwlObjectPropertyReferences();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectProperty, OWLAxiom> result26 = testSubject0
                .getOwlObjectPropertyReferences();
        ...
        boolean result30 = testSubject0
                .removeImportsDeclaration(_OWLImportsDeclaration);
        boolean result31 = testSubject0
                .removeOntologyAnnotation(_OWLAnnotation);
        testSubject0
                .removePropertyChainSubPropertyAxioms(_OWLSubPropertyChainOfAxiom);
        java.util.Set<OWLImportsDeclaration> result32 = testSubject0
                .getImportsDeclarations();
        java.util.Set<OWLAxiom> result33 = testSubject0
                .getAxioms();
        ...
        java.util.Set<OWLClassAxiom> result38 = testSubject0
                .getGeneralClassAxioms();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result42 = testSubject0
                .getClassAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLClassAxiom> result43 = testSubject0
                .getClassAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLSubClassOfAxiom> result44 = testSubject0
                .getSubClassAxiomsByLHS();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result45 = testSubject0
                .getSubClassAxiomsByLHS();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result46 = testSubject0
                .getSubClassAxiomsByRHS();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLSubClassOfAxiom> result47 = testSubject0
                .getSubClassAxiomsByRHS();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result48 = testSubject0
                .getEquivalentClassesAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLEquivalentClassesAxiom> result49 = testSubject0
                .getEquivalentClassesAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result50 = testSubject0
                .getDisjointClassesAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLDisjointClassesAxiom> result51 = testSubject0
                .getDisjointClassesAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result52 = testSubject0
                .getDisjointUnionAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLDisjointUnionAxiom> result53 = testSubject0
                .getDisjointUnionAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClass, OWLHasKeyAxiom> result54 = testSubject0
                .getHasKeyAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result55 = testSubject0
                .getHasKeyAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLSubObjectPropertyOfAxiom> result56 = testSubject0
                .getObjectSubPropertyAxiomsByLHS();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result57 = testSubject0
                .getObjectSubPropertyAxiomsByLHS();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result58 = testSubject0
                .getObjectSubPropertyAxiomsByRHS();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLSubObjectPropertyOfAxiom> result59 = testSubject0
                .getObjectSubPropertyAxiomsByRHS();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result63 = testSubject0
                .getDisjointObjectPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLObjectPropertyDomainAxiom> result64 = testSubject0
                .getObjectPropertyDomainAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result65 = testSubject0
                .getObjectPropertyDomainAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLObjectPropertyRangeAxiom> result66 = testSubject0
                .getObjectPropertyRangeAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result67 = testSubject0
                .getObjectPropertyRangeAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result68 = testSubject0
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result71 = testSubject0
                .getInverseFunctionalPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLSymmetricObjectPropertyAxiom> result72 = testSubject0
                .getSymmetricPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result73 = testSubject0
                .getSymmetricPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLAsymmetricObjectPropertyAxiom> result74 = testSubject0
                .getAsymmetricPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result75 = testSubject0
                .getAsymmetricPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLReflexiveObjectPropertyAxiom> result76 = testSubject0
                .getReflexivePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result77 = testSubject0
                .getReflexivePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLIrreflexiveObjectPropertyAxiom> result78 = testSubject0
                .getIrreflexivePropertyAxiomsByProperty();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result80 = testSubject0
                .getTransitivePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLTransitiveObjectPropertyAxiom> result81 = testSubject0
                .getTransitivePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result82 = testSubject0
                .getInversePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLObjectPropertyExpression, OWLInverseObjectPropertiesAxiom> result83 = testSubject0
                .getInversePropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result84 = testSubject0
                .getDataSubPropertyAxiomsByLHS();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLSubDataPropertyOfAxiom> result85 = testSubject0
                .getDataSubPropertyAxiomsByLHS();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLSubDataPropertyOfAxiom> result86 = testSubject0
                .getDataSubPropertyAxiomsByRHS();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result88 = testSubject0
                .getEquivalentDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLEquivalentDataPropertiesAxiom> result89 = testSubject0
                .getEquivalentDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result90 = testSubject0
                .getDisjointDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLDisjointDataPropertiesAxiom> result91 = testSubject0
                .getDisjointDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLDataPropertyDomainAxiom> result92 = testSubject0
                .getDataPropertyDomainAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result93 = testSubject0
                .getDataPropertyDomainAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLDataPropertyRangeAxiom> result94 = testSubject0
                .getDataPropertyRangeAxiomsByProperty();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result96 = testSubject0
                .getFunctionalDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLDataPropertyExpression, OWLFunctionalDataPropertyAxiom> result97 = testSubject0
                .getFunctionalDataPropertyAxiomsByProperty();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result98 = testSubject0
                .getClassAssertionAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLClassAssertionAxiom> result99 = testSubject0
                .getClassAssertionAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result100 = testSubject0
                .getClassAssertionAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLClassExpression, OWLClassAssertionAxiom> result101 = testSubject0
                .getClassAssertionAxiomsByClass();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLObjectPropertyAssertionAxiom> result102 = testSubject0
                .getObjectPropertyAssertionsByIndividual();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result104 = testSubject0
                .getDataPropertyAssertionsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLDataPropertyAssertionAxiom> result105 = testSubject0
                .getDataPropertyAssertionsByIndividual();
        ...
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result110 = testSubject0
                .getDifferentIndividualsAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLDifferentIndividualsAxiom> result111 = testSubject0
                .getDifferentIndividualsAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLIndividual, OWLSameIndividualAxiom> result112 = testSubject0
                .getSameIndividualsAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.Internals.Pointer result113 = testSubject0
                .getSameIndividualsAxiomsByIndividual();
        uk.ac.manchester.cs.owl.owlapi.MapPointer<OWLAnnotationSubject, OWLAnnotationAssertionAxiom> result114 = testSubject0
                .getAnnotationAssertionAxiomsBySubject();
    ...
    public void verifyInternalsNoCache()  {
        ...
        OWLDatatype result2 = testSubject0
                .getTopDatatype();
        OWLObjectProperty result3 = testSubject0
                .getOWLObjectProperty(_IRI);
        OWLDataProperty result4 = testSubject0
        ...
        OWLDatatype result7 = testSubject0
                .getOWLDatatype(_IRI);
        OWLDatatype result8 = testSubject0
                .getIntegerOWLDatatype();
        OWLDatatype result9 = testSubject0
                .getFloatOWLDatatype();
        OWLDatatype result10 = testSubject0
                .getDoubleOWLDatatype();
        OWLDatatype result11 = testSubject0
                .getBooleanOWLDatatype();
        OWLLiteral result12 = testSubject0
                .getOWLLiteral(_int);
        OWLLiteral result13 = testSubject0
                .getOWLLiteral(_boolean);
        OWLLiteral result14 = testSubject0
                .getOWLLiteral(_double);
        OWLLiteral result15 = testSubject0
                .getOWLLiteral(_String, _OWLDatatype);
        OWLLiteral result16 = testSubject0
                .getOWLLiteral(_String, _String);
        OWLLiteral result17 = testSubject0
                .getOWLLiteral(_String);
        OWLLiteral result18 = testSubject0
    ...
    public void verifyMapPointer()  {
        MapPointer testSubject0 = new MapPointer(_AxiomType97,
                _OWLAxiomVisitorEx, _boolean, _Internals);
        boolean result0 = testSubject0.remove(_Object, _OWLAxiom);
        boolean result1 = testSubject0.put(_Object, _OWLAxiom);
        boolean result2 = testSubject0.contains(_Object, _OWLAxiom);
        int result3 = testSubject0.size();
    ...
    public void verifyOWL2DatatypeImpl()  {
        ...
        DataRangeType result15 = testSubject0
                .getDataRangeType();
        ...
        OWLDatatype result26 = OWL2DatatypeImpl
                .getDatatype(_OWL2Datatype);
    ...
    public void enforceInterfacesOWLAnnotationAssertionAxiomImpl()
        ...
        assertTrue(OWLAnnotationAssertionAxiom.class
                .isAssignableFrom(OWLAnnotationAssertionAxiomImpl.class));
    }
    ...
    public void verifyOWLAnnotationAssertionAxiomImpl()  {
        OWLAnnotationAssertionAxiomImpl testSubject0 = new OWLAnnotationAssertionAxiomImpl(
                _OWLAnnotationSubject, _OWLAnnotationProperty,
                _OWLAnnotationValue, _Collection);
        ...
        OWLAnnotationSubject result5 = testSubject0
                .getSubject();
        ...
        OWLAxiom result8 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAnnotationAssertionAxiom result9 = testSubject0
        ...
        AxiomType<?> result13 = testSubject0
                .getAxiomType();
        java.util.Set<OWLAnnotation> result14 = testSubject0
                .getAnnotations(_OWLAnnotationProperty);
        java.util.Set<OWLAnnotation> result15 = testSubject0
                .getAnnotations();
    ...
    public void verifyOWLAnnotationImpl()  {
        ...
        OWLAnnotation result8 = testSubject0
        ...
        java.util.Set<OWLEntity> result11 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result12 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result13 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result14 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result15 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result16 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result17 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result18 = testSubject0
                .getNestedClassExpressions();
    ...
    public void enforceInterfacesOWLAnnotationPropertyDomainAxiomImpl()
        ...
        assertTrue(OWLAnnotationPropertyDomainAxiom.class
                .isAssignableFrom(OWLAnnotationPropertyDomainAxiomImpl.class));
    }
    ...
    public void verifyOWLAnnotationPropertyDomainAxiomImpl()  {
        ...
        OWLAnnotationPropertyDomainAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLAnnotationPropertyDomainAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
    ...
    public void enforceInterfacesOWLAnnotationPropertyImpl()  {
        ...
        assertTrue(OWLAnnotationProperty.class
                .isAssignableFrom(OWLAnnotationPropertyImpl.class));
    }
    ...
    public void verifyOWLAnnotationPropertyImpl()  {
        ...
        java.util.Set<OWLAnnotationProperty> result6 = testSubject0
                .getSuperProperties(_OWLOntology);
        java.util.Set<OWLAnnotationProperty> result7 = testSubject0
                .getSuperProperties(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationProperty> result8 = testSubject0
                .getSubProperties(_OWLOntology);
        java.util.Set<OWLAnnotationProperty> result9 = testSubject0
                .getSubProperties(_Set);
        java.util.Set<OWLAnnotationProperty> result10 = testSubject0
        ...
        java.util.Set<OWLAxiom> result15 = testSubject0
                .getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAxiom> result16 = testSubject0
                .getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAnnotationAssertionAxiom> result17 = testSubject0
                .getAnnotationAssertionAxioms(_OWLOntology);
        IRI result18 = testSubject0.getIRI();
        EntityType<?> result19 = testSubject0
                .getEntityType();
        OWLEntity result20 = testSubject0.getOWLEntity(_EntityType123);
        boolean result21 = testSubject0.isOWLClass();
        OWLClass result22 = testSubject0
                .asOWLClass();
        boolean result23 = testSubject0.isOWLObjectProperty();
        OWLObjectProperty result24 = testSubject0
                .asOWLObjectProperty();
        ...
        OWLDatatype result30 = testSubject0
                .asOWLDatatype();
        ...
        java.util.Set<OWLEntity> result36 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result37 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result38 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result39 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result40 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result41 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result42 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result43 = testSubject0
                .getNestedClassExpressions();
    ...
    public void enforceInterfacesOWLAnnotationPropertyRangeAxiomImpl()
        ...
        assertTrue(OWLAnnotationPropertyRangeAxiom.class
                .isAssignableFrom(OWLAnnotationPropertyRangeAxiomImpl.class));
    }
    ...
    public void verifyOWLAnnotationPropertyRangeAxiomImpl()  {
        ...
        OWLAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLAnnotationPropertyRangeAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
        boolean result8 = testSubject0.isLogicalAxiom();
        boolean result9 = testSubject0.isAnnotationAxiom();
        AxiomType<?> result10 = testSubject0
    ...
    public void verifyOWLAnonymousClassExpressionImpl()  {
        ...
        java.util.Set<OWLEntity> result12 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result13 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result14 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result15 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result16 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result17 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result18 = testSubject0
                .getDatatypesInSignature();
        ...
        ClassExpressionType result24 = testSubject0
    ...
    public void enforceInterfacesOWLAnonymousIndividualImpl()  {
        ...
        assertTrue(OWLAnonymousIndividual.class
                .isAssignableFrom(OWLAnonymousIndividualImpl.class));
    }
    ...
    public void verifyOWLAnonymousIndividualImpl()  {
        ...
        OWLNamedIndividual result8 = testSubject0
                .asOWLNamedIndividual();
        ...
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result12 = testSubject0
                .getObjectPropertyValues(_OWLOntology);
        java.util.Set<OWLIndividual> result13 = testSubject0
        ...
        boolean result15 = testSubject0.hasDataPropertyValue(
                _OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        boolean result16 = testSubject0.hasNegativeObjectPropertyValue(
                _OWLObjectPropertyExpression, _OWLIndividual, _OWLOntology);
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result17 = testSubject0
                .getNegativeObjectPropertyValues(_OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result18 = testSubject0
                .getDataPropertyValues(_OWLOntology);
        java.util.Set<OWLLiteral> result19 = testSubject0
                .getDataPropertyValues(_OWLDataPropertyExpression, _OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result20 = testSubject0
                .getNegativeDataPropertyValues(_OWLOntology);
        boolean result21 = testSubject0.hasNegativeDataPropertyValue(
                _OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        java.util.Set<OWLIndividual> result22 = testSubject0
                .getSameIndividuals(_OWLOntology);
        java.util.Set<OWLIndividual> result23 = testSubject0
                .getDifferentIndividuals(_OWLOntology);
        boolean result24 = testSubject0.isBuiltIn();
        boolean result25 = testSubject0.isOWLClass();
        OWLClass result26 = testSubject0
                .asOWLClass();
        boolean result27 = testSubject0.isOWLObjectProperty();
        OWLObjectProperty result28 = testSubject0
                .asOWLObjectProperty();
        boolean result29 = testSubject0.isOWLDataProperty();
        OWLDataProperty result30 = testSubject0
                .asOWLDataProperty();
        boolean result31 = testSubject0.isOWLDatatype();
        OWLDatatype result32 = testSubject0
                .asOWLDatatype();
        int result33 = testSubject0.compareTo(_Object110);
        int result34 = testSubject0.compareTo(_OWLObject);
        java.util.Set<OWLEntity> result35 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result36 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result37 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result38 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result39 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result40 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result41 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result42 = testSubject0
                .getNestedClassExpressions();
    ...
    public void enforceInterfacesOWLAsymmetricObjectPropertyAxiomImpl()
        ...
        assertTrue(OWLAsymmetricObjectPropertyAxiom.class
                .isAssignableFrom(OWLAsymmetricObjectPropertyAxiomImpl.class));
    }
    ...
    public void verifyOWLAsymmetricObjectPropertyAxiomImpl()  {
        ...
        OWLAsymmetricObjectPropertyAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAsymmetricObjectPropertyAxiom result4 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result6 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result7 = testSubject0
                .getProperty();
        OWLObjectPropertyExpression result8 = testSubject0
                .getProperty();
    ...
    public void verifyOWLAxiomImpl()  {
        ...
        java.util.Set<OWLEntity> result9 = testSubject0
                .getSignature();
        ...
        OWLAxiom result21 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result22 = testSubject0
                .getAnnotatedAxiom(_Set129);
        boolean result23 = testSubject0.isLogicalAxiom();
        boolean result24 = testSubject0.isAnnotationAxiom();
        AxiomType<?> result25 = testSubject0
                .getAxiomType();
    }
    ...
    public void verifyOWLCardinalityRestrictionImpl()  {
        ...
        testSubject0.accept(_OWLClassExpressionVisitor);
        ClassExpressionType result28 = testSubject0
                .getClassExpressionType();
    ...
    public void enforceInterfacesOWLClassAssertionAxiomImpl()  {
        ...
        assertTrue(OWLClassAssertionAxiom.class
                .isAssignableFrom(OWLClassAssertionAxiomImpl.class));
    }
    ...
    public void verifyOWLClassAssertionAxiomImpl()  {
        ...
        OWLClassExpression result3 = testSubject0
                .getClassExpression();
        OWLSubClassOfAxiom result4 = testSubject0
                .asOWLSubClassOfAxiom();
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLClassAssertionAxiom result6 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLClassAssertionAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result8 = testSubject0
                .getAnnotatedAxiom(_Set130);
        ...
        java.util.Set<OWLAnnotation> result12 = testSubject0
                .getAnnotations(_OWLAnnotationProperty);
        java.util.Set<OWLAnnotation> result13 = testSubject0
                .getAnnotations();
        testSubject0.accept(_CollectionContainerVisitor131);
    ...
    public void verifyOWLClassAxiomImpl()  {
        ...
        OWLAxiom result23 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result24 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result25 = testSubject0
                .getAxiomType();
    }
    ...
    public void verifyOWLClassExpressionImpl()  {
        ...
        ClassExpressionType result15 = testSubject0
                .getClassExpressionType();
        ...
        OWLClass result25 = testSubject0
                .asOWLClass();
    }
    ...
    public void verifyOWLClassImpl()  {
        ...
        ClassExpressionType result19 = testSubject0
                .getClassExpressionType();
        ...
        java.util.Set<OWLClassExpression> result26 = testSubject0
                .asDisjunctSet();
        java.util.Set<OWLSubClassOfAxiom> result27 = testSubject0
        ...
        java.util.Set<OWLAxiom> result33 = testSubject0
                .getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result34 = testSubject0
                .getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result35 = testSubject0
                .getAnnotationAssertionAxioms(_OWLOntology);
        java.util.Set<OWLEquivalentClassesAxiom> result36 = testSubject0
                .getEquivalentClassesAxioms(_OWLOntology);
        java.util.Set<OWLDisjointClassesAxiom> result37 = testSubject0
                .getDisjointClassesAxioms(_OWLOntology);
        java.util.Set<OWLDisjointUnionAxiom> result38 = testSubject0
        ...
        java.util.Set<OWLEntity> result57 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result58 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result59 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result60 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result61 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result62 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result63 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result64 = testSubject0
                .getNestedClassExpressions();
    }
    ...
    public void enforceInterfacesOWLDataAllValuesFromImpl()  {
        ...
        assertTrue(OWLDataAllValuesFrom.class
                .isAssignableFrom(OWLDataAllValuesFromImpl.class));
    }
    ...
    public void verifyOWLDataCardinalityRestrictionImpl()  {
        ...
        testSubject0.accept(_OWLClassExpressionVisitor);
        ClassExpressionType result31 = testSubject0
                .getClassExpressionType();
    }
    ...
    public void enforceInterfacesOWLDataComplementOfImpl()  {
        ...
        assertTrue(OWLDataComplementOf.class
                .isAssignableFrom(OWLDataComplementOfImpl.class));
    }
    ...
    public void verifyOWLDataComplementOfImpl()  {
        ...
        DataRangeType result5 = testSubject0
                .getDataRangeType();
        OWLDataRange result6 = testSubject0
                .getDataRange();
        OWLDatatype result7 = testSubject0
                .asOWLDatatype();
        int result8 = testSubject0.compareTo(_Object110);
        int result9 = testSubject0.compareTo(_OWLObject);
        java.util.Set<OWLEntity> result10 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result11 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result12 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result13 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result14 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result15 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result16 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result17 = testSubject0
                .getNestedClassExpressions();
    ...
    public void enforceInterfacesOWLDataExactCardinalityImpl()  {
        ...
        assertTrue(OWLDataExactCardinality.class
                .isAssignableFrom(OWLDataExactCardinalityImpl.class));
    }
    ...
    public void enforceInterfacesOWLDataFactoryImpl()  {
        assertTrue(OWLDataFactory.class
    ...
    public void verifyOWLDataFactoryImpl()  {
        OWLDataFactoryImpl testSubject0 = new OWLDataFactoryImpl(_boolean,
                _boolean);
        OWLDataFactoryImpl testSubject1 = new OWLDataFactoryImpl();
        OWLDataFactory result0 = OWLDataFactoryImpl
                .getInstance();
        ...
        OWLAnnotationProperty result36 = testSubject0
                .getOWLDeprecated();
        ...
        OWLDatatype result42 = testSubject0
                .getDoubleOWLDatatype();
        OWLDatatype result43 = testSubject0
                .getBooleanOWLDatatype();
        ...
        OWLLiteral result60 = testSubject0
        ...
        OWLDataMaxCardinality result93 = testSubject0
                .getOWLDataMaxCardinality(_int, _OWLDataPropertyExpression,
                        _OWLDataRange);
        OWLDataMaxCardinality result94 = testSubject0
                .getOWLDataMaxCardinality(_int, _OWLDataPropertyExpression);
        OWLDataMinCardinality result95 = testSubject0
                .getOWLDataMinCardinality(_int, _OWLDataPropertyExpression,
                        _OWLDataRange);
        OWLDataMinCardinality result96 = testSubject0
                .getOWLDataMinCardinality(_int, _OWLDataPropertyExpression);
        OWLDataHasValue result97 = testSubject0
        ...
        OWLObjectMaxCardinality result108 = testSubject0
                .getOWLObjectMaxCardinality(_int, _OWLObjectPropertyExpression);
        OWLObjectHasSelf result109 = testSubject0
                .getOWLObjectHasSelf(_OWLObjectPropertyExpression);
        OWLObjectHasValue result110 = testSubject0
        ...
        OWLObjectUnionOf result112 = testSubject0
        ...
        OWLSubClassOfAxiom result115 = testSubject0
                .getOWLSubClassOfAxiom(_OWLClassExpression,
                        _OWLClassExpression, _Set134);
        OWLSubClassOfAxiom result116 = testSubject0
        ...
        OWLSubPropertyChainOfAxiom result121 = testSubject0
                .getOWLSubPropertyChainOfAxiom(_List,
                        _OWLObjectPropertyExpression, _Set134);
        ...
        OWLHasKeyAxiom result169 = testSubject0
        ...
        OWLAnnotation result194 = testSubject0
                .getOWLAnnotation(_OWLAnnotationProperty, _OWLAnnotationValue,
                        _Set134);
        ...
        SWRLRule result207 = testSubject0
                .getSWRLRule(_NodeID, _Set170, _Set170);
        SWRLRule result208 = testSubject0
                .getSWRLRule(_Set170, _Set170);
        SWRLRule result209 = testSubject0
                .getSWRLRule(_IRI, _Set170, _Set170);
        SWRLRule result210 = testSubject0
                .getSWRLRule(_Set170, _Set170, _Set129);
    ...
    public void verifyOWLDataFactoryInternalsImpl()  {
        ...
        OWLLiteral result7 = testSubject0
                .getOWLLiteral(_int);
        OWLLiteral result8 = testSubject0
                .getOWLLiteral(_double);
        OWLLiteral result9 = testSubject0
                .getOWLLiteral(_String, _OWLDatatype);
        OWLLiteral result10 = testSubject0
                .getOWLLiteral(_float);
        OWLDatatype result11 = testSubject0
                .getTopDatatype();
        OWLDatatype result12 = testSubject0
                .getRDFPlainLiteral();
        OWLDatatype result13 = testSubject0
                .getIntegerOWLDatatype();
        OWLDatatype result14 = testSubject0
                .getFloatOWLDatatype();
        OWLDatatype result15 = testSubject0
                .getDoubleOWLDatatype();
        OWLDatatype result16 = testSubject0
                .getBooleanOWLDatatype();
        OWLLiteral result17 = testSubject0
                .getOWLLiteral(_boolean);
        OWLLiteral result18 = testSubject0
    ...
    public void enforceInterfacesOWLDataHasValueImpl()  {
        ...
        assertTrue(OWLDataHasValue.class
                .isAssignableFrom(OWLDataHasValueImpl.class));
    }
    ...
    public void enforceInterfacesOWLDataIntersectionOfImpl()  {
        ...
        assertTrue(OWLDataIntersectionOf.class
                .isAssignableFrom(OWLDataIntersectionOfImpl.class));
    }
    ...
    public void verifyOWLDataIntersectionOfImpl()  {
        ...
        testSubject0.accept(_OWLObjectVisitor);
        DataRangeType result3 = testSubject0
                .getDataRangeType();
        boolean result4 = testSubject0.isDatatype();
        boolean result5 = testSubject0.isTopDatatype();
        OWLDatatype result6 = testSubject0
                .asOWLDatatype();
        java.util.Set<OWLDataRange> result7 = testSubject0
                .getOperands();
        int result8 = testSubject0.compareTo(_Object110);
        int result9 = testSubject0.compareTo(_OWLObject);
        java.util.Set<OWLEntity> result10 = testSubject0
    ...
    public void enforceInterfacesOWLDataMaxCardinalityImpl()  {
        ...
        assertTrue(OWLDataMaxCardinality.class
                .isAssignableFrom(OWLDataMaxCardinalityImpl.class));
    }
    ...
    public void enforceInterfacesOWLDataMinCardinalityImpl()  {
        ...
        assertTrue(OWLDataMinCardinality.class
                .isAssignableFrom(OWLDataMinCardinalityImpl.class));
    }
    ...
    public void enforceInterfacesOWLDataPropertyAssertionAxiomImpl()
        ...
        assertTrue(OWLDataPropertyAssertionAxiom.class
                .isAssignableFrom(OWLDataPropertyAssertionAxiomImpl.class));
    }
    ...
    public void verifyOWLDataPropertyAssertionAxiomImpl()  {
        OWLDataPropertyAssertionAxiomImpl testSubject0 = new OWLDataPropertyAssertionAxiomImpl(
                _OWLIndividual, _OWLDataPropertyExpression, _OWLLiteral,
                _Set134);
        testSubject0.accept(_OWLAxiomVisitor);
        testSubject0.accept(_OWLObjectVisitor);
        OWLObject result0 = testSubject0.accept(_OWLAxiomVisitorEx127);
        OWLObject result1 = testSubject0.accept(_OWLObjectVisitorEx);
        OWLSubClassOfAxiom result2 = testSubject0
                .asOWLSubClassOfAxiom();
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDataPropertyAssertionAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLDataPropertyAssertionAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result8 = testSubject0.getProperty();
        OWLObject result9 = testSubject0.getObject();
        OWLIndividual result10 = testSubject0
                .getSubject();
        boolean result11 = testSubject0.isLogicalAxiom();
        boolean result12 = testSubject0.isAnnotationAxiom();
        java.util.Set<OWLAnnotation> result13 = testSubject0
    ...
    public void verifyOWLDataPropertyCharacteristicAxiomImpl()  {
        ...
        java.util.Set<OWLEntity> result13 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result14 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result15 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result16 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result17 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result18 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result19 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result20 = testSubject0
                .getNestedClassExpressions();
        ...
        OWLAxiom result25 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result26 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result27 = testSubject0
                .getAxiomType();
    }
    ...
    public void enforceInterfacesOWLDataPropertyDomainAxiomImpl()
        ...
        assertTrue(OWLDataPropertyDomainAxiom.class
                .isAssignableFrom(OWLDataPropertyDomainAxiomImpl.class));
    }
    ...
    public void verifyOWLDataPropertyDomainAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDataPropertyDomainAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result6 = testSubject0
    ...
    public void enforceInterfacesOWLDataPropertyImpl()  {
        ...
        assertTrue(OWLDataProperty.class
                .isAssignableFrom(OWLDataPropertyImpl.class));
    }
    ...
    public void verifyOWLDataPropertyImpl()  {
        ...
        boolean result17 = testSubject0.isAnonymous();
        java.util.Set<OWLAxiom> result18 = testSubject0
                .getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAxiom> result19 = testSubject0
                .getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAnnotationAssertionAxiom> result20 = testSubject0
                .getAnnotationAssertionAxioms(_OWLOntology);
        IRI result21 = testSubject0.getIRI();
        EntityType<?> result22 = testSubject0
                .getEntityType();
        ...
        OWLObjectProperty result27 = testSubject0
                .asOWLObjectProperty();
        boolean result28 = testSubject0.isOWLDataProperty();
        OWLDataProperty result29 = testSubject0
                .asOWLDataProperty();
        boolean result30 = testSubject0.isOWLNamedIndividual();
        OWLNamedIndividual result31 = testSubject0
                .asOWLNamedIndividual();
        boolean result32 = testSubject0.isOWLDatatype();
        OWLDatatype result33 = testSubject0
                .asOWLDatatype();
        boolean result34 = testSubject0.isOWLAnnotationProperty();
        OWLAnnotationProperty result35 = testSubject0
                .asOWLAnnotationProperty();
        String result36 = testSubject0.toStringID();
        java.util.Set<OWLClassExpression> result37 = testSubject0
                .getDomains(_Set);
        java.util.Set<OWLClassExpression> result38 = testSubject0
                .getDomains(_OWLOntology);
        java.util.Set<OWLDataRange> result39 = testSubject0
        ...
        java.util.Set<OWLEntity> result51 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result52 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result53 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result54 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result55 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result56 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result57 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result58 = testSubject0
                .getNestedClassExpressions();
    }
    ...
    public void enforceInterfacesOWLDataPropertyRangeAxiomImpl()
        ...
        assertTrue(OWLDataPropertyRangeAxiom.class
                .isAssignableFrom(OWLDataPropertyRangeAxiomImpl.class));
    }
    ...
    public void verifyOWLDataPropertyRangeAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDataPropertyRangeAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result6 = testSubject0
    ...
    public void enforceInterfacesOWLDataSomeValuesFromImpl()  {
        ...
        assertTrue(OWLDataSomeValuesFrom.class
                .isAssignableFrom(OWLDataSomeValuesFromImpl.class));
    }
    ...
    public void enforceInterfacesOWLDatatypeDefinitionAxiomImpl()
        ...
        assertTrue(OWLDatatypeDefinitionAxiom.class
                .isAssignableFrom(OWLDatatypeDefinitionAxiomImpl.class));
    }
    ...
    public void verifyOWLDatatypeDefinitionAxiomImpl()  {
        ...
        testSubject0.accept(_OWLAxiomVisitor);
        testSubject0.accept(_OWLObjectVisitor);
        OWLDataRange result2 = testSubject0
                .getDataRange();
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDatatypeDefinitionAxiom result4 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        boolean result6 = testSubject0.isLogicalAxiom();
        boolean result7 = testSubject0.isAnnotationAxiom();
        AxiomType<?> result8 = testSubject0
                .getAxiomType();
        OWLDatatype result9 = testSubject0
                .getDatatype();
    ...
    public void verifyOWLDatatypeImpl()  {
        ...
        DataRangeType result12 = testSubject0
                .getDataRangeType();
        ...
        java.util.Set<OWLAxiom> result20 = testSubject0
                .getReferencingAxioms(_OWLOntology);
        java.util.Set<OWLAxiom> result21 = testSubject0
                .getReferencingAxioms(_OWLOntology, _boolean);
        java.util.Set<OWLAnnotationAssertionAxiom> result22 = testSubject0
                .getAnnotationAssertionAxioms(_OWLOntology);
        IRI result23 = testSubject0.getIRI();
        EntityType<?> result24 = testSubject0
                .getEntityType();
        OWLEntity result25 = testSubject0.getOWLEntity(_EntityType123);
        boolean result26 = testSubject0.isOWLClass();
        OWLClass result27 = testSubject0
                .asOWLClass();
        boolean result28 = testSubject0.isOWLObjectProperty();
        OWLObjectProperty result29 = testSubject0
                .asOWLObjectProperty();
        boolean result30 = testSubject0.isOWLDataProperty();
        OWLDataProperty result31 = testSubject0
                .asOWLDataProperty();
        boolean result32 = testSubject0.isOWLNamedIndividual();
        OWLNamedIndividual result33 = testSubject0
                .asOWLNamedIndividual();
        boolean result34 = testSubject0.isOWLDatatype();
        OWLDatatype result35 = testSubject0
                .asOWLDatatype();
        boolean result36 = testSubject0.isOWLAnnotationProperty();
        OWLAnnotationProperty result37 = testSubject0
                .asOWLAnnotationProperty();
    ...
    public void enforceInterfacesOWLDatatypeRestrictionImpl()  {
        ...
        assertTrue(OWLDatatypeRestriction.class
                .isAssignableFrom(OWLDatatypeRestrictionImpl.class));
    }
    ...
    public void verifyOWLDatatypeRestrictionImpl()  {
        ...
        OWLDatatype result6 = testSubject0
                .getDatatype();
        java.util.Set<OWLFacetRestriction> result7 = testSubject0
    ...
    public void enforceInterfacesOWLDataUnionOfImpl()  {
        ...
        assertTrue(OWLDataUnionOf.class
                .isAssignableFrom(OWLDataUnionOfImpl.class));
    }
    ...
    public void verifyOWLDeclarationAxiomImpl()  {
        ...
        OWLAxiom result2 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDeclarationAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result4 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLDeclarationAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set129);
        boolean result6 = testSubject0.isLogicalAxiom();
        boolean result7 = testSubject0.isAnnotationAxiom();
        AxiomType<?> result8 = testSubject0
                .getAxiomType();
        OWLEntity result9 = testSubject0
                .getEntity();
        java.util.Set<OWLAnnotation> result10 = testSubject0
                .getAnnotations(_OWLAnnotationProperty);
        java.util.Set<OWLAnnotation> result11 = testSubject0
    ...
    public void enforceInterfacesOWLDifferentIndividualsAxiomImpl()
        ...
        assertTrue(OWLDifferentIndividualsAxiom.class
                .isAssignableFrom(OWLDifferentIndividualsAxiomImpl.class));
    }
    ...
    public void verifyOWLDifferentIndividualsAxiomImpl()  {
        ...
        OWLObject result0 = testSubject0.accept(_OWLObjectVisitorEx);
        OWLObject result1 = testSubject0.accept(_OWLAxiomVisitorEx127);
        java.util.Set<OWLDifferentIndividualsAxiom> result2 = testSubject0
                .asPairwiseAxioms();
        java.util.Set<OWLSubClassOfAxiom> result3 = testSubject0
                .asOWLSubClassOfAxioms();
        boolean result4 = testSubject0.containsAnonymousIndividuals();
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDifferentIndividualsAxiom result6 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLDifferentIndividualsAxiom result8 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result9 = testSubject0
                .getAxiomType();
        java.util.Set<OWLIndividual> result10 = testSubject0
                .getIndividuals();
        java.util.List<OWLIndividual> result11 = testSubject0
    ...
    public void enforceInterfacesOWLDisjointClassesAxiomImpl()  {
        ...
        assertTrue(OWLDisjointClassesAxiom.class
                .isAssignableFrom(OWLDisjointClassesAxiomImpl.class));
    }
    ...
    public void verifyOWLDisjointClassesAxiomImpl()  {
        ...
        OWLObject result1 = testSubject0.accept(_OWLObjectVisitorEx);
        testSubject0.accept(_OWLAxiomVisitor);
        java.util.Set<OWLDisjointClassesAxiom> result2 = testSubject0
                .asPairwiseAxioms();
        java.util.Set<OWLSubClassOfAxiom> result3 = testSubject0
                .asOWLSubClassOfAxioms();
        OWLAxiom result4 = testSubject0
        ...
        java.util.Set<OWLClassExpression> result10 = testSubject0
                .getClassExpressions();
        java.util.List<OWLClassExpression> result11 = testSubject0
        ...
        java.util.Set<OWLAnnotation> result15 = testSubject0
                .getAnnotations(_OWLAnnotationProperty);
        java.util.Set<OWLAnnotation> result16 = testSubject0
                .getAnnotations();
        testSubject0.accept(_CollectionContainerVisitor131);
        ...
        java.util.Set<OWLEntity> result24 = testSubject0
                .getSignature();
    ...
    public void enforceInterfacesOWLDisjointDataPropertiesAxiomImpl()
        ...
        assertTrue(OWLDisjointDataPropertiesAxiom.class
                .isAssignableFrom(OWLDisjointDataPropertiesAxiomImpl.class));
    }
    ...
    public void verifyOWLDisjointDataPropertiesAxiomImpl()  {
        ...
        OWLDisjointDataPropertiesAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDisjointDataPropertiesAxiom result4 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result6 = testSubject0
    ...
    public void enforceInterfacesOWLDisjointObjectPropertiesAxiomImpl()
        ...
        assertTrue(OWLDisjointObjectPropertiesAxiom.class
                .isAssignableFrom(OWLDisjointObjectPropertiesAxiomImpl.class));
    }
    ...
    public void verifyOWLDisjointObjectPropertiesAxiomImpl()  {
        ...
        OWLDisjointObjectPropertiesAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDisjointObjectPropertiesAxiom result4 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result6 = testSubject0
    ...
    public void verifyOWLDisjointUnionAxiomImpl()  {
        ...
        OWLClass result5 = testSubject0
                .getOWLClass();
        OWLAxiom result6 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLDisjointUnionAxiom result7 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result8 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLDisjointUnionAxiom result9 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result10 = testSubject0
                .getAxiomType();
        boolean result11 = testSubject0.isLogicalAxiom();
    ...
    public void enforceInterfacesOWLEquivalentClassesAxiomImpl()
        ...
        assertTrue(OWLEquivalentClassesAxiom.class
                .isAssignableFrom(OWLEquivalentClassesAxiomImpl.class));
        assertTrue(java.io.Serializable.class
                .isAssignableFrom(OWLEquivalentClassesAxiomImpl.class));
    }
    ...
    public void verifyOWLEquivalentClassesAxiomImpl()  {
        ...
        java.util.Set<OWLEquivalentClassesAxiom> result6 = testSubject0
                .asPairwiseAxioms();
        java.util.Set<OWLSubClassOfAxiom> result7 = testSubject0
                .asOWLSubClassOfAxioms();
        OWLAxiom result8 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLEquivalentClassesAxiom result9 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLEquivalentClassesAxiom result10 = testSubject0
                .getAnnotatedAxiom(_Set129);
        ...
        java.util.Set<OWLClassExpression> result14 = testSubject0
                .getClassExpressions();
        java.util.List<OWLClassExpression> result15 = testSubject0
                .getClassExpressionsAsList();
        java.util.Set<OWLClassExpression> result16 = testSubject0
                .getClassExpressionsMinus(_OWLClassExpression_array);
        boolean result17 = testSubject0.isLogicalAxiom();
        boolean result18 = testSubject0.isAnnotationAxiom();
        java.util.Set<OWLAnnotation> result19 = testSubject0
                .getAnnotations(_OWLAnnotationProperty);
        java.util.Set<OWLAnnotation> result20 = testSubject0
                .getAnnotations();
        testSubject0.accept(_CollectionContainerVisitor131);
        ...
        java.util.Set<OWLEntity> result28 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result29 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result30 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result31 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result32 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result33 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result34 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result35 = testSubject0
                .getNestedClassExpressions();
    ...
    public void enforceInterfacesOWLEquivalentDataPropertiesAxiomImpl()
        ...
        assertTrue(OWLEquivalentDataPropertiesAxiom.class
                .isAssignableFrom(OWLEquivalentDataPropertiesAxiomImpl.class));
    }
    ...
    public void verifyOWLEquivalentDataPropertiesAxiomImpl()  {
        ...
        OWLObject result1 = testSubject0.accept(_OWLObjectVisitorEx);
        testSubject0.accept(_OWLAxiomVisitor);
        java.util.Set<OWLSubDataPropertyOfAxiom> result2 = testSubject0
                .asSubDataPropertyOfAxioms();
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLEquivalentDataPropertiesAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLEquivalentDataPropertiesAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        java.util.Set<OWLDataPropertyExpression> result8 = testSubject0
    ...
    public void enforceInterfacesOWLEquivalentObjectPropertiesAxiomImpl()
        ...
        assertTrue(OWLEquivalentObjectPropertiesAxiom.class
                .isAssignableFrom(OWLEquivalentObjectPropertiesAxiomImpl.class));
    }
    ...
    public void verifyOWLEquivalentObjectPropertiesAxiomImpl()  {
        ...
        OWLObject result1 = testSubject0.accept(_OWLObjectVisitorEx);
        testSubject0.accept(_OWLAxiomVisitor);
        java.util.Set<OWLSubObjectPropertyOfAxiom> result2 = testSubject0
                .asSubObjectPropertyOfAxioms();
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLEquivalentObjectPropertiesAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLEquivalentObjectPropertiesAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        java.util.Set<OWLObjectPropertyExpression> result8 = testSubject0
    ...
    public void enforceInterfacesOWLFunctionalDataPropertyAxiomImpl()
        ...
        assertTrue(OWLFunctionalDataPropertyAxiom.class
                .isAssignableFrom(OWLFunctionalDataPropertyAxiomImpl.class));
    }
    ...
    public void verifyOWLFunctionalDataPropertyAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLFunctionalDataPropertyAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLFunctionalDataPropertyAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result8 = testSubject0
                .getProperty();
        OWLDataPropertyExpression result9 = testSubject0
                .getProperty();
        boolean result10 = testSubject0.isLogicalAxiom();
        boolean result11 = testSubject0.isAnnotationAxiom();
        java.util.Set<OWLAnnotation> result12 = testSubject0
    ...
    public void enforceInterfacesOWLFunctionalObjectPropertyAxiomImpl()
        ...
        assertTrue(OWLFunctionalObjectPropertyAxiom.class
                .isAssignableFrom(OWLFunctionalObjectPropertyAxiomImpl.class));
    }
    ...
    public void verifyOWLFunctionalObjectPropertyAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLFunctionalObjectPropertyAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLFunctionalObjectPropertyAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result8 = testSubject0
                .getProperty();
        OWLObjectPropertyExpression result9 = testSubject0
                .getProperty();
        boolean result10 = testSubject0.isLogicalAxiom();
        boolean result11 = testSubject0.isAnnotationAxiom();
        java.util.Set<OWLAnnotation> result12 = testSubject0
    ...
    public void verifyOWLHasKeyAxiomImpl()  {
        ...
        OWLClassExpression result2 = testSubject0
                .getClassExpression();
        java.util.Set<OWLPropertyExpression<?, ?>> result3 = testSubject0
                .getPropertyExpressions();
        java.util.Set<OWLObjectPropertyExpression> result4 = testSubject0
                .getObjectPropertyExpressions();
        java.util.Set<OWLDataPropertyExpression> result5 = testSubject0
                .getDataPropertyExpressions();
        OWLAxiom result6 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLHasKeyAxiom result7 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLHasKeyAxiom result8 = testSubject0
                .getAnnotatedAxiom(_Set129);
    ...
    public void enforceInterfacesOWLImportsDeclarationImpl()  {
        assertTrue(OWLImportsDeclaration.class
    ...
    public void verifyOWLIndividualImpl()  {
        ...
        java.util.Set<OWLClassExpression> result1 = testSubject0
                .getTypes(_OWLOntology);
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result2 = testSubject0
                .getObjectPropertyValues(_OWLOntology);
        ...
        boolean result4 = testSubject0.hasObjectPropertyValue(
                _OWLObjectPropertyExpression, _OWLIndividual, _OWLOntology);
        boolean result5 = testSubject0.hasDataPropertyValue(
                _OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        ...
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result7 = testSubject0
                .getNegativeObjectPropertyValues(_OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result8 = testSubject0
                .getDataPropertyValues(_OWLOntology);
        java.util.Set<OWLLiteral> result9 = testSubject0
                .getDataPropertyValues(_OWLDataPropertyExpression, _OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result10 = testSubject0
                .getNegativeDataPropertyValues(_OWLOntology);
        boolean result11 = testSubject0.hasNegativeDataPropertyValue(
                _OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        java.util.Set<OWLIndividual> result12 = testSubject0
                .getSameIndividuals(_OWLOntology);
        java.util.Set<OWLIndividual> result13 = testSubject0
                .getDifferentIndividuals(_OWLOntology);
        boolean result14 = testSubject0.isBuiltIn();
        ...
        OWLObjectProperty result18 = testSubject0
                .asOWLObjectProperty();
        boolean result19 = testSubject0.isOWLDataProperty();
        OWLDataProperty result20 = testSubject0
                .asOWLDataProperty();
        boolean result21 = testSubject0.isOWLDatatype();
        OWLDatatype result22 = testSubject0
                .asOWLDatatype();
        ...
        java.util.Set<OWLEntity> result25 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result26 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result27 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result28 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result29 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result30 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result31 = testSubject0
                .getDatatypesInSignature();
        ...
        OWLAnonymousIndividual result38 = testSubject0
                .asOWLAnonymousIndividual();
        boolean result39 = testSubject0.isAnonymous();
        OWLNamedIndividual result40 = testSubject0
                .asOWLNamedIndividual();
    ...
    public void verifyOWLIndividualRelationshipAxiomImpl()  {
        OWLIndividualRelationshipAxiomImpl<OWLObjectPropertyExpression, OWLIndividual> testSubject0 = new OWLIndividualRelationshipAxiomImpl(
                _OWLIndividual, _OWLPropertyExpression, _OWLIndividual,
                _Collection) {
        ...
        OWLAxiom result26 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result27 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result28 = testSubject0
                .getAxiomType();
    ...
    public void enforceInterfacesOWLInverseFunctionalObjectPropertyAxiomImpl()
        ...
        assertTrue(OWLInverseFunctionalObjectPropertyAxiom.class
                .isAssignableFrom(OWLInverseFunctionalObjectPropertyAxiomImpl.class));
    }
    ...
    public void verifyOWLInverseFunctionalObjectPropertyAxiomImpl()
        ...
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLInverseFunctionalObjectPropertyAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result8 = testSubject0
    ...
    public void enforceInterfacesOWLInverseObjectPropertiesAxiomImpl()
        ...
        assertTrue(OWLInverseObjectPropertiesAxiom.class
                .isAssignableFrom(OWLInverseObjectPropertiesAxiomImpl.class));
    }
    ...
    public void verifyOWLInverseObjectPropertiesAxiomImpl()  {
        ...
        OWLObjectPropertyExpression result2 = testSubject0
                .getSecondProperty();
        java.util.Set<OWLSubObjectPropertyOfAxiom> result3 = testSubject0
                .asSubObjectPropertyOfAxioms();
        OWLObjectPropertyExpression result4 = testSubject0
                .getFirstProperty();
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLInverseObjectPropertiesAxiom result6 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLInverseObjectPropertiesAxiom result8 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result9 = testSubject0
                .getAxiomType();
    ...
    public void enforceInterfacesOWLIrreflexiveObjectPropertyAxiomImpl()
        ...
        assertTrue(OWLIrreflexiveObjectPropertyAxiom.class
                .isAssignableFrom(OWLIrreflexiveObjectPropertyAxiomImpl.class));
    }
    ...
    public void verifyOWLIrreflexiveObjectPropertyAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLIrreflexiveObjectPropertyAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLIrreflexiveObjectPropertyAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result7 = testSubject0
    ...
    public void enforceInterfacesOWLLiteralImpl()  {
        ...
        assertTrue(OWLLiteral.class
                .isAssignableFrom(OWLLiteralImpl.class));
    }

    public void verifyOWLLiteralImpl()  {
        OWLLiteralImpl testSubject0 = new OWLLiteralImpl(_String, _String,
                _OWLDatatype);
    ...
    public void verifyOWLLiteralImplFloat()  {
        OWLLiteralImplFloat testSubject0 = new OWLLiteralImplFloat(_float,
                _OWLDatatype);
        boolean result0 = testSubject0.parseBoolean();
        float result1 = testSubject0.parseFloat();
        double result2 = testSubject0.parseDouble();
    ...
    public void verifyOWLLiteralImplInteger()  {
        OWLLiteralImplInteger testSubject0 = new OWLLiteralImplInteger(_int,
                _OWLDatatype);
        boolean result0 = testSubject0.parseBoolean();
        float result1 = testSubject0.parseFloat();
        double result2 = testSubject0.parseDouble();
    ...
    public void enforceInterfacesOWLNamedIndividualImpl()  {
        ...
        assertTrue(OWLNamedIndividual.class
                .isAssignableFrom(OWLNamedIndividualImpl.class));
    }
    ...
    public void verifyOWLNamedIndividualImpl()  {
        ...
        java.util.Set<OWLClassExpression> result21 = testSubject0
                .getTypes(_OWLOntology);
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result22 = testSubject0
                .getObjectPropertyValues(_OWLOntology);
        java.util.Set<OWLIndividual> result23 = testSubject0
                .getObjectPropertyValues(_OWLObjectPropertyExpression,
                        _OWLOntology);
        boolean result24 = testSubject0.hasObjectPropertyValue(
                _OWLObjectPropertyExpression, _OWLIndividual, _OWLOntology);
        boolean result25 = testSubject0.hasDataPropertyValue(
                _OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        boolean result26 = testSubject0.hasNegativeObjectPropertyValue(
                _OWLObjectPropertyExpression, _OWLIndividual, _OWLOntology);
        java.util.Map<OWLObjectPropertyExpression, java.util.Set<OWLIndividual>> result27 = testSubject0
                .getNegativeObjectPropertyValues(_OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result28 = testSubject0
                .getDataPropertyValues(_OWLOntology);
        java.util.Set<OWLLiteral> result29 = testSubject0
                .getDataPropertyValues(_OWLDataPropertyExpression, _OWLOntology);
        java.util.Map<OWLDataPropertyExpression, java.util.Set<OWLLiteral>> result30 = testSubject0
                .getNegativeDataPropertyValues(_OWLOntology);
        boolean result31 = testSubject0.hasNegativeDataPropertyValue(
                _OWLDataPropertyExpression, _OWLLiteral, _OWLOntology);
        java.util.Set<OWLIndividual> result32 = testSubject0
                .getSameIndividuals(_OWLOntology);
        ...
        java.util.Set<OWLEntity> result45 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result46 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result47 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result48 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result49 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result50 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result51 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result52 = testSubject0
                .getNestedClassExpressions();
    ...
    public void verifyOWLNaryBooleanClassExpressionImpl()  {
        ...
        java.util.List<OWLClassExpression> result1 = testSubject0
                .getOperandsAsList();
        java.util.Set<OWLClassExpression> result2 = testSubject0
                .getOperands();
        ...
        testSubject0.accept(_OWLClassExpressionVisitor);
        ClassExpressionType result27 = testSubject0
                .getClassExpressionType();
    }
    ...
    public void verifyOWLNaryClassAxiomImpl()  {
        ...
        OWLAxiom result27 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result28 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result29 = testSubject0
                .getAxiomType();
        java.util.Set<? extends OWLNaryAxiom> result30 = testSubject0
                .asPairwiseAxioms();
    ...
    public void verifyOWLNaryDataRangeImpl()  {
        ...
        OWLDatatype result2 = testSubject0
                .asOWLDatatype();
        java.util.Set<OWLDataRange> result3 = testSubject0
                .getOperands();
        int result4 = testSubject0.compareTo(_Object110);
        int result5 = testSubject0.compareTo(_OWLObject);
        java.util.Set<OWLEntity> result6 = testSubject0
        ...
        testSubject0.accept(_OWLDataVisitor);
        DataRangeType result19 = testSubject0
                .getDataRangeType();
    }
    ...
    public void verifyOWLNaryIndividualAxiomImpl()  {
        ...
        AxiomType<?> result27 = testSubject0
                .getAxiomType();
        java.util.Set<? extends OWLNaryAxiom> result28 = testSubject0
                .asPairwiseAxioms();
        java.util.Set<OWLSubClassOfAxiom> result29 = testSubject0
                .asOWLSubClassOfAxioms();
    }
    ...
    public void enforceInterfacesOWLNegativeDataPropertyAssertionAxiomImpl()
        ...
        assertTrue(OWLNegativeDataPropertyAssertionAxiom.class
                .isAssignableFrom(OWLNegativeDataPropertyAssertionAxiomImpl.class));
    }
    ...
    public void verifyOWLNegativeDataPropertyAssertionAxiomImpl()
        ...
        OWLAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLNegativeDataPropertyAssertionAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLNegativeDataPropertyAssertionAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result8 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result9 = testSubject0.getProperty();
    ...
    public void enforceInterfacesOWLNegativeObjectPropertyAssertionAxiomImpl()
        ...
        assertTrue(OWLNegativeObjectPropertyAssertionAxiom.class
                .isAssignableFrom(OWLNegativeObjectPropertyAssertionAxiomImpl.class));
    }
    ...
    public void verifyOWLNegativeObjectPropertyAssertionAxiomImpl()
        ...
        OWLNegativeObjectPropertyAssertionAxiomImpl testSubject0 = new OWLNegativeObjectPropertyAssertionAxiomImpl(
                _OWLIndividual, _OWLObjectPropertyExpression, _OWLIndividual,
                _Set134);
        testSubject0.accept(_OWLObjectVisitor);
        testSubject0.accept(_OWLAxiomVisitor);
        OWLObject result0 = testSubject0.accept(_OWLObjectVisitorEx);
        ...
        OWLSubClassOfAxiom result2 = testSubject0
                .asOWLSubClassOfAxiom();
        boolean result3 = testSubject0.containsAnonymousIndividuals();
        OWLNegativeObjectPropertyAssertionAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLNegativeObjectPropertyAssertionAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result8 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result9 = testSubject0.getProperty();
    ...
    public void enforceInterfacesOWLObjectAllValuesFromImpl()  {
        ...
        assertTrue(OWLObjectAllValuesFrom.class
                .isAssignableFrom(OWLObjectAllValuesFromImpl.class));
    }
    ...
    public void enforceInterfacesOWLObjectComplementOfImpl()  {
        ...
        assertTrue(OWLObjectComplementOf.class
                .isAssignableFrom(OWLObjectComplementOfImpl.class));
    }
    ...
    public void enforceInterfacesOWLObjectExactCardinalityImpl()
        ...
        assertTrue(OWLObjectExactCardinality.class
                .isAssignableFrom(OWLObjectExactCardinalityImpl.class));
    }
    ...
    public void enforceInterfacesOWLObjectHasSelfImpl()  {
        ...
        assertTrue(OWLObjectHasSelf.class
                .isAssignableFrom(OWLObjectHasSelfImpl.class));
    }
    ...
    public void enforceInterfacesOWLObjectHasValueImpl()  {
        ...
        assertTrue(OWLObjectHasValue.class
                .isAssignableFrom(OWLObjectHasValueImpl.class));
    }
    ...
    public void enforceInterfacesOWLObjectIntersectionOfImpl()  {
        ...
        assertTrue(OWLObjectIntersectionOf.class
                .isAssignableFrom(OWLObjectIntersectionOfImpl.class));
    }
    ...
    public void verifyOWLObjectIntersectionOfImpl()  {
        ...
        java.util.List<OWLClassExpression> result6 = testSubject0
                .getOperandsAsList();
        java.util.Set<OWLClassExpression> result7 = testSubject0
                .getOperands();
        boolean result8 = testSubject0.isOWLThing();
    ...
    public void enforceInterfacesOWLObjectInverseOfImpl()  {
        ...
        assertTrue(OWLObjectInverseOf.class
                .isAssignableFrom(OWLObjectInverseOfImpl.class));
    }
    ...
    public void verifyOWLObjectInverseOfImpl()  {
        ...
        OWLObjectPropertyExpression result6 = testSubject0
                .getInverse();
        boolean result7 = testSubject0.isAnonymous();
        OWLObjectProperty result8 = testSubject0
                .asOWLObjectProperty();
        ...
        java.util.Set<OWLObjectPropertyExpression> result15 = testSubject0
                .getInverses(_OWLOntology);
        java.util.Set<OWLObjectPropertyExpression> result16 = testSubject0
                .getInverses(_Set);
        OWLObjectPropertyExpression result17 = testSubject0
                .getInverseProperty();
        OWLObjectPropertyExpression result18 = testSubject0
                .getSimplified();
        ...
        java.util.Set<OWLEntity> result44 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result45 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result46 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result47 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result48 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result49 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result50 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result51 = testSubject0
                .getNestedClassExpressions();
    ...
    public void enforceInterfacesOWLObjectMaxCardinalityImpl()  {
        ...
        assertTrue(OWLObjectMaxCardinality.class
                .isAssignableFrom(OWLObjectMaxCardinalityImpl.class));
    }
    ...
    public void enforceInterfacesOWLObjectMinCardinalityImpl()  {
        ...
        assertTrue(OWLObjectMinCardinality.class
                .isAssignableFrom(OWLObjectMinCardinalityImpl.class));
    }
    ...
    public void enforceInterfacesOWLObjectOneOfImpl()  {
        ...
        assertTrue(OWLObjectOneOf.class
                .isAssignableFrom(OWLObjectOneOfImpl.class));
    }
    ...
    public void verifyOWLObjectOneOfImpl()  {
        ...
        OWLObject result1 = testSubject0.accept(_OWLObjectVisitorEx);
        testSubject0.accept(_OWLClassExpressionVisitor);
        java.util.Set<OWLIndividual> result2 = testSubject0
                .getIndividuals();
    ...
    public void enforceInterfacesOWLObjectPropertyAssertionAxiomImpl()
        ...
        assertTrue(OWLObjectPropertyAssertionAxiom.class
                .isAssignableFrom(OWLObjectPropertyAssertionAxiomImpl.class));
    }
    ...
    public void verifyOWLObjectPropertyAssertionAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLObjectPropertyAssertionAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLObjectPropertyAssertionAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result7 = testSubject0
    ...
    public void enforceInterfacesOWLObjectPropertyDomainAxiomImpl()
        ...
        assertTrue(OWLObjectPropertyDomainAxiom.class
                .isAssignableFrom(OWLObjectPropertyDomainAxiomImpl.class));
    }
    ...
    public void verifyOWLObjectPropertyDomainAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLObjectPropertyDomainAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLObjectPropertyDomainAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        OWLClassExpression result8 = testSubject0
    ...
    public void verifyOWLObjectPropertyExpressionImpl()  {
        ...
        OWLObjectProperty result14 = testSubject0
                .getNamedProperty();
        ...
        OWLObjectProperty result52 = testSubject0
                .asOWLObjectProperty();
    }
    ...
    public void enforceInterfacesOWLObjectPropertyImpl()  {
        ...
        assertTrue(OWLObjectProperty.class
                .isAssignableFrom(OWLObjectPropertyImpl.class));
    }
    ...
    public void verifyOWLObjectPropertyImpl()  {
        ...
        OWLObject result3 = testSubject0.accept(_OWLObjectVisitorEx);
        OWLObject result4 = testSubject0.accept(_OWLEntityVisitorEx);
        OWLObject result5 = testSubject0
                .accept(_OWLPropertyExpressionVisitorEx);
        testSubject0.accept(_OWLNamedObjectVisitor);
        ...
        java.util.Set<OWLObjectPropertyExpression> result40 = testSubject0
                .getInverses(_Set);
        OWLObjectPropertyExpression result41 = testSubject0
                .getInverseProperty();
        OWLObjectPropertyExpression result42 = testSubject0
                .getSimplified();
        ...
        java.util.Set<OWLClassExpression> result54 = testSubject0
                .getDomains(_Set);
        java.util.Set<OWLClassExpression> result55 = testSubject0
                .getDomains(_OWLOntology);
        java.util.Set<OWLClassExpression> result56 = testSubject0
                .getRanges(_OWLOntology);
        java.util.Set<OWLClassExpression> result57 = testSubject0
                .getRanges(_Set);
        ...
        java.util.Set<OWLEntity> result68 = testSubject0
                .getSignature();
        java.util.Set<OWLClass> result69 = testSubject0
                .getClassesInSignature();
        java.util.Set<OWLAnonymousIndividual> result70 = testSubject0
                .getAnonymousIndividuals();
        java.util.Set<OWLDataProperty> result71 = testSubject0
                .getDataPropertiesInSignature();
        java.util.Set<OWLObjectProperty> result72 = testSubject0
                .getObjectPropertiesInSignature();
        java.util.Set<OWLNamedIndividual> result73 = testSubject0
                .getIndividualsInSignature();
        java.util.Set<OWLDatatype> result74 = testSubject0
                .getDatatypesInSignature();
        java.util.Set<OWLClassExpression> result75 = testSubject0
                .getNestedClassExpressions();
    }
    ...
    public void enforceInterfacesOWLObjectPropertyRangeAxiomImpl()
        ...
        assertTrue(OWLObjectPropertyRangeAxiom.class
                .isAssignableFrom(OWLObjectPropertyRangeAxiomImpl.class));
    }
    ...
    public void verifyOWLObjectPropertyRangeAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLObjectPropertyRangeAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLObjectPropertyRangeAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
    ...
    public void enforceInterfacesOWLObjectSomeValuesFromImpl()  {
        ...
        assertTrue(OWLObjectSomeValuesFrom.class
                .isAssignableFrom(OWLObjectSomeValuesFromImpl.class));
    }
    ...
    public void enforceInterfacesOWLObjectUnionOfImpl()  {
        ...
        assertTrue(OWLObjectUnionOf.class
                .isAssignableFrom(OWLObjectUnionOfImpl.class));
    }
    ...
    public void verifyOWLObjectUnionOfImpl()  {
        ...
        java.util.Set<OWLClassExpression> result3 = testSubject0
                .asDisjunctSet();
        boolean result4 = testSubject0.isClassExpressionLiteral();
        java.util.List<OWLClassExpression> result5 = testSubject0
                .getOperandsAsList();
        java.util.Set<OWLClassExpression> result6 = testSubject0
                .getOperands();
        boolean result7 = testSubject0.isOWLThing();
    ...
    public void enforceInterfacesOWLOntologyImpl()  {
        ...
        assertTrue(OWLMutableOntology.class
                .isAssignableFrom(OWLOntologyImpl.class));
        assertTrue(java.io.Serializable.class
                .isAssignableFrom(OWLOntologyImpl.class));
    }
    ...
    public void verifyOWLOntologyImpl()  {
        ...
        testSubject0.accept(_OWLNamedObjectVisitor);
        OWLObject result4 = testSubject0.accept(_OWLObjectVisitorEx);
        OWLOntologyID result5 = testSubject0
                .getOntologyID();
        ...
        java.util.Set<OWLImportsDeclaration> result23 = testSubject0
                .getImportsDeclarations();
        java.util.Set<OWLAnnotationAxiom> result24 = testSubject0
                .getAxioms(_OWLAnnotationProperty);
        java.util.Set<OWLClassAxiom> result25 = testSubject0
                .getAxioms(_OWLClass);
        java.util.Set<OWLObjectPropertyAxiom> result26 = testSubject0
        ...
        java.util.Set<OWLIndividualAxiom> result29 = testSubject0
        ...
        java.util.Set<OWLAxiom> result32 = testSubject0.getAxioms(_AxiomType,
                _boolean);
        ...
        boolean result43 = testSubject0
                .containsAxiomIgnoreAnnotations(_OWLAxiom96);
        boolean result44 = testSubject0.containsAxiomIgnoreAnnotations(
                _OWLAxiom96, _boolean);
        ...
        boolean result55 = testSubject0.containsEntityInSignature(_IRI,
                _boolean);
        ...
        java.util.List<OWLOntologyChange> result114 = testSubject0
                .applyChanges(_List182);
        java.util.List<OWLOntologyChange> result115 = testSubject0
                .applyChange(_OWLOntologyChange);
        boolean result116 = testSubject0.containsReference(_OWLDatatype);
        boolean result117 = testSubject0
                .containsReference(_OWLAnnotationProperty);
        ...
        java.util.Set<OWLNamedObject> result122 = testSubject0
                .getReferencedObjects();
        java.util.Set<OWLAnnotationProperty> result123 = testSubject0
    ...
    public void enforceInterfacesOWLOntologyManagerImpl()  {
        assertTrue(OWLOntologyManager.class
                .isAssignableFrom(OWLOntologyManagerImpl.class));
        assertTrue(OWLOntologyFactory.OWLOntologyCreationHandler.class
                .isAssignableFrom(OWLOntologyManagerImpl.class));
        assertTrue(java.io.Serializable.class
                .isAssignableFrom(OWLOntologyManagerImpl.class));
    }

    public void verifyOWLOntologyManagerImpl()  {
        ...
        OWLOntologyManagerProperties result3 = testSubject0
                .getProperties();
        OWLOntology result4 = testSubject0
                .getOntology(_IRI);
        OWLOntology result5 = testSubject0
        ...
        java.util.Set<OWLOntology> result10 = testSubject0
                .getOntologies();
        java.util.Set<OWLOntology> result11 = testSubject0
                .getOntologies(_OWLAxiom96);
        java.util.Set<OWLOntology> result12 = testSubject0
                .getVersions(_IRI);
        boolean result13 = testSubject0.containsVersion(_IRI);
        java.util.Set<OWLOntologyID> result14 = testSubject0
                .getOntologyIDsByVersion(_IRI);
        OWLOntology result15 = testSubject0
                .getImportedOntology(_OWLImportsDeclaration);
        java.util.List<OWLOntology> result16 = testSubject0
        ...
        java.util.List<OWLOntologyChange> result21 = testSubject0
                .removeAxioms(_OWLOntology, _Set186);
        java.util.List<OWLOntologyChange> result22 = testSubject0
                .applyChange(_OWLOntologyChange);
        OWLOntology result23 = testSubject0
                .createOntology(_IRI, _IRI);
        ...
        OWLOntology result28 = testSubject0
                .createOntology(_IRI, _Set, _boolean);
        OWLOntology result29 = testSubject0
                .createOntology(_Set187, _IRI);
        OWLOntology result30 = testSubject0
                .createOntology(_IRI, _Set);
        ...
        java.util.Collection<OWLOntologyFactory> result39 = testSubject0
    ...
    public void enforceInterfacesOWLReflexiveObjectPropertyAxiomImpl()
        ...
        assertTrue(OWLReflexiveObjectPropertyAxiom.class
                .isAssignableFrom(OWLReflexiveObjectPropertyAxiomImpl.class));
    }
    ...
    public void verifyOWLReflexiveObjectPropertyAxiomImpl()  {
        ...
        OWLSubClassOfAxiom result2 = testSubject0
                .asOWLSubClassOfAxiom();
        OWLReflexiveObjectPropertyAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLReflexiveObjectPropertyAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result8 = testSubject0
    ...
    public void verifyOWLRestrictionImpl()  {
        OWLRestrictionImpl testSubject0 = new OWLRestrictionImpl(
        ...
        testSubject0.accept(_OWLClassExpressionVisitor);
        ClassExpressionType result26 = testSubject0
                .getClassExpressionType();
    ...
    public void enforceInterfacesOWLSameIndividualAxiomImpl()  {
        ...
        assertTrue(OWLSameIndividualAxiom.class
                .isAssignableFrom(OWLSameIndividualAxiomImpl.class));
    }
    ...
    public void verifyOWLSameIndividualAxiomImpl()  {
        ...
        testSubject0.accept(_OWLObjectVisitor);
        testSubject0.accept(_OWLAxiomVisitor);
        java.util.Set<OWLSameIndividualAxiom> result2 = testSubject0
                .asPairwiseAxioms();
        java.util.Set<OWLSubClassOfAxiom> result3 = testSubject0
                .asOWLSubClassOfAxioms();
        boolean result4 = testSubject0.containsAnonymousIndividuals();
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLSameIndividualAxiom result6 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLSameIndividualAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result8 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result9 = testSubject0
                .getAxiomType();
        java.util.Set<OWLSameIndividualAxiom> result10 = testSubject0
                .asPairwiseSameIndividualAxioms();
        java.util.Set<OWLIndividual> result11 = testSubject0
                .getIndividuals();
        java.util.List<OWLIndividual> result12 = testSubject0
                .getIndividualsAsList();
        boolean result13 = testSubject0.isLogicalAxiom();
        boolean result14 = testSubject0.isAnnotationAxiom();
        java.util.Set<OWLAnnotation> result15 = testSubject0
    ...
    public void enforceInterfacesOWLSubAnnotationPropertyOfAxiomImpl()
        ...
        assertTrue(OWLSubAnnotationPropertyOfAxiom.class
                .isAssignableFrom(OWLSubAnnotationPropertyOfAxiomImpl.class));
    }
    ...
    public void verifyOWLSubAnnotationPropertyOfAxiomImpl()  {
        ...
        OWLObject result1 = testSubject0.accept(_OWLObjectVisitorEx);
        testSubject0.accept(_OWLObjectVisitor);
        OWLAnnotationProperty result2 = testSubject0
                .getSubProperty();
        OWLAnnotationProperty result3 = testSubject0
                .getSuperProperty();
        OWLSubAnnotationPropertyOfAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLSubAnnotationPropertyOfAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
        boolean result8 = testSubject0.isLogicalAxiom();
        boolean result9 = testSubject0.isAnnotationAxiom();
        AxiomType<?> result10 = testSubject0
    ...
    public void enforceInterfacesOWLSubClassOfAxiomImpl()  {
        ...
        assertTrue(OWLSubClassOfAxiom.class
                .isAssignableFrom(OWLSubClassOfAxiomImpl.class));
    }
    ...
    public void verifyOWLSubClassOfAxiomImpl()  {
        ...
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLSubClassOfAxiom result6 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLSubClassOfAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result8 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result9 = testSubject0
    ...
    public void enforceInterfacesOWLSubDataPropertyOfAxiomImpl()
        ...
        assertTrue(OWLSubDataPropertyOfAxiom.class
                .isAssignableFrom(OWLSubDataPropertyOfAxiomImpl.class));
    }
    ...
    public void verifyOWLSubDataPropertyOfAxiomImpl()  {
        ...
        OWLAxiom result4 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLSubDataPropertyOfAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result6 = testSubject0
                .getAxiomType();
    ...
    public void enforceInterfacesOWLSubObjectPropertyOfAxiomImpl()
        ...
        assertTrue(OWLSubObjectPropertyOfAxiom.class
                .isAssignableFrom(OWLSubObjectPropertyOfAxiomImpl.class));
    }
    ...
    public void verifyOWLSubObjectPropertyOfAxiomImpl()  {
        ...
        OWLSubObjectPropertyOfAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLSubObjectPropertyOfAxiom result4 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result6 = testSubject0
    ...
    public void enforceInterfacesOWLSubPropertyChainAxiomImpl()
        ...
        assertTrue(OWLSubPropertyChainOfAxiom.class
                .isAssignableFrom(OWLSubPropertyChainAxiomImpl.class));
    }
    ...
    public void verifyOWLSubPropertyChainAxiomImpl()  {
        ...
        OWLAxiom result5 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLSubPropertyChainOfAxiom result6 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLSubPropertyChainOfAxiom result7 = testSubject0
                .getAnnotatedAxiom(_Set129);
        OWLAxiom result8 = testSubject0
                .getAnnotatedAxiom(_Set130);
        AxiomType<?> result9 = testSubject0
    ...
    public void enforceInterfacesOWLSymmetricObjectPropertyAxiomImpl()
        ...
        assertTrue(OWLSymmetricObjectPropertyAxiom.class
                .isAssignableFrom(OWLSymmetricObjectPropertyAxiomImpl.class));
    }
    ...
    public void verifyOWLSymmetricObjectPropertyAxiomImpl()  {
        ...
        OWLAxiom result3 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLSymmetricObjectPropertyAxiom result4 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result5 = testSubject0
                .getAnnotatedAxiom(_Set130);
        OWLSymmetricObjectPropertyAxiom result6 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result7 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result8 = testSubject0
    ...
    public void enforceInterfacesOWLTransitiveObjectPropertyAxiomImpl()
        ...
        assertTrue(OWLTransitiveObjectPropertyAxiom.class
                .isAssignableFrom(OWLTransitiveObjectPropertyAxiomImpl.class));
    }
    ...
    public void verifyOWLTransitiveObjectPropertyAxiomImpl()  {
        ...
        OWLAxiom result4 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result5 = testSubject0
                .getAxiomType();
        OWLPropertyExpression result6 = testSubject0
                .getProperty();
    ...
    public void verifyOWLUnaryPropertyAxiomImpl()  {
        ...
        OWLAxiom result25 = testSubject0
                .getAnnotatedAxiom(_Set129);
        AxiomType<?> result26 = testSubject0
                .getAxiomType();
    }
    ...
    public void verifyOWLValueRestrictionImpl()  {
        ...
        boolean result28 = testSubject0.isObjectRestriction();
        boolean result29 = testSubject0.isDataRestriction();
        OWLClassExpression result30 = testSubject0
                .asSomeValuesFrom();
    }
    ...
    public void verifySWRLAtomImpl()  {
        ...
        testSubject0.accept(_OWLObjectVisitor);
        java.util.Collection<SWRLArgument> result14 = testSubject0
                .getAllArguments();
    ...
    public void verifySWRLBinaryAtomImpl()  {
        SWRLBinaryAtomImpl testSubject0 = new SWRLBinaryAtomImpl(
                _SWRLPredicate, _SWRLArgument, _SWRLArgument) {
    ...
    public void enforceInterfacesSWRLBuiltInAtomImpl()  {
        ...
        assertTrue(SWRLBuiltInAtom.class
                .isAssignableFrom(SWRLBuiltInAtomImpl.class));
    }

    public void verifySWRLBuiltInAtomImpl()  {
        SWRLBuiltInAtomImpl testSubject0 = new SWRLBuiltInAtomImpl(_IRI,
                _List173);
        testSubject0.accept(_SWRLObjectVisitor);
        testSubject0.accept(_OWLObjectVisitor);
        ...
        java.util.List<SWRLDArgument> result6 = testSubject0
                .getArguments();
        int result7 = testSubject0.compareTo(_Object110);
        int result8 = testSubject0.compareTo(_OWLObject);
        java.util.Set<OWLEntity> result9 = testSubject0
    ...
    public void enforceInterfacesSWRLDataPropertyAtomImpl()  {
        ...
        assertTrue(SWRLDataPropertyAtom.class
                .isAssignableFrom(SWRLDataPropertyAtomImpl.class));
    }
    ...
    public void verifySWRLDataRangeAtomImpl()  {
        ...
        SWRLPredicate result2 = testSubject0
                .getPredicate();
        OWLDataRange result3 = testSubject0
                .getPredicate();
    ...
    public void enforceInterfacesSWRLDifferentIndividualsAtomImpl()
        ...
        assertTrue(SWRLDifferentIndividualsAtom.class
                .isAssignableFrom(SWRLDifferentIndividualsAtomImpl.class));
    }
    ...
    public void verifySWRLDifferentIndividualsAtomImpl()  {
        ...
        java.util.Collection<SWRLArgument> result4 = testSubject0
                .getAllArguments();
        SWRLPredicate result5 = testSubject0
                .getPredicate();
        int result6 = testSubject0.compareTo(_Object110);
        int result7 = testSubject0.compareTo(_OWLObject);
        java.util.Set<OWLEntity> result8 = testSubject0
    ...
    public void enforceInterfacesSWRLIndividualArgumentImpl()  {
        ...
        assertTrue(SWRLIndividualArgument.class
                .isAssignableFrom(SWRLIndividualArgumentImpl.class));
    }
    ...
    public void enforceInterfacesSWRLLiteralArgumentImpl()  {
        ...
        assertTrue(SWRLLiteralArgument.class
                .isAssignableFrom(SWRLLiteralArgumentImpl.class));
    }
    ...
    public void enforceInterfacesSWRLObjectPropertyAtomImpl()  {
        ...
        assertTrue(SWRLObjectPropertyAtom.class
                .isAssignableFrom(SWRLObjectPropertyAtomImpl.class));
    }
    ...
    public void verifySWRLObjectPropertyAtomImpl()  {
        ...
        SWRLPredicate result2 = testSubject0
                .getPredicate();
        OWLObjectPropertyExpression result3 = testSubject0
                .getPredicate();
        SWRLObjectPropertyAtom result4 = testSubject0
                .getSimplified();
        SWRLIArgument result5 = testSubject0.getFirstArgument();
        SWRLIArgument result6 = testSubject0.getSecondArgument();
        java.util.Collection<SWRLArgument> result7 = testSubject0
                .getAllArguments();
        int result8 = testSubject0.compareTo(_Object110);
        int result9 = testSubject0.compareTo(_OWLObject);
        java.util.Set<OWLEntity> result10 = testSubject0
    ...
    public void enforceInterfacesSWRLRuleImpl()  {
        ...
        assertTrue(SWRLRule.class
                .isAssignableFrom(SWRLRuleImpl.class));
    }

    public void verifySWRLRuleImpl()  {
        SWRLRuleImpl testSubject0 = new SWRLRuleImpl(_Set170, _Set170,
                _Collection);
        testSubject0.accept(_OWLObjectVisitor);
        OWLObject result0 = testSubject0.accept(_OWLObjectVisitorEx);
        testSubject0.accept(_SWRLObjectVisitor);
        ...
        java.util.Set<SWRLAtom> result5 = testSubject0
                .getBody();
        java.util.Set<SWRLAtom> result6 = testSubject0
                .getHead();
        java.util.Set<SWRLVariable> result7 = testSubject0
                .getVariables();
        SWRLRule result8 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result9 = testSubject0
                .getAxiomWithoutAnnotations();
        OWLAxiom result10 = testSubject0
        ...
        AxiomType<?> result12 = testSubject0
                .getAxiomType();
        SWRLRule result13 = testSubject0
                .getSimplified();
        boolean result14 = testSubject0.isAnnotationAxiom();
        java.util.Set<OWLAnnotation> result15 = testSubject0
                .getAnnotations(_OWLAnnotationProperty);
    ...
    public void enforceInterfacesSWRLSameIndividualAtomImpl()  {
        ...
        assertTrue(SWRLSameIndividualAtom.class
                .isAssignableFrom(SWRLSameIndividualAtomImpl.class));
    }
