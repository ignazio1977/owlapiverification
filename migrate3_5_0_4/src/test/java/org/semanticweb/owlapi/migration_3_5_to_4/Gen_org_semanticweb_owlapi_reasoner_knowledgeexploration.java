...
public class Gen_org_semanticweb_owlapi_reasoner_knowledgeexploration {
    ...
    public void verifyInterfaceOWLKnowledgeExplorerReasoner()  {
        ...
        org.semanticweb.owlapi.reasoner.Node<? extends OWLObjectPropertyExpression> result2 = testSubject0
        ...
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result4 = testSubject0
                .getDataNeighbours(_RootNode, _boolean);
        org.semanticweb.owlapi.reasoner.Node<? extends OWLClassExpression> result5 = testSubject0
                .getObjectLabel(_RootNode, _boolean);
        org.semanticweb.owlapi.reasoner.Node<? extends OWLDataRange> result6 = testSubject0
        ...
        testSubject0.flush();
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result8 = testSubject0
                .getSuperClasses(_OWLClassExpression, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result9 = testSubject0
                .getSubClasses(_OWLClassExpression, _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result10 = testSubject0
        ...
        org.semanticweb.owlapi.reasoner.NodeSet<OWLNamedIndividual> result13 = testSubject0
                .getObjectPropertyValues(_OWLNamedIndividual,
                        _OWLObjectPropertyExpression);
        java.util.Set<OWLLiteral> result14 = testSubject0
                .getDataPropertyValues(_OWLNamedIndividual, _OWLDataProperty);
        org.semanticweb.owlapi.reasoner.Node<OWLNamedIndividual> result15 = testSubject0
        ...
        org.semanticweb.owlapi.reasoner.BufferingMode result22 = testSubject0
                .getBufferingMode();
        java.util.List<OWLOntologyChange> result23 = testSubject0
                .getPendingChanges();
        java.util.Set<OWLAxiom> result24 = testSubject0
                .getPendingAxiomAdditions();
        java.util.Set<OWLAxiom> result25 = testSubject0
        ...
        boolean result34 = testSubject0
                .isEntailmentCheckingSupported(_AxiomType);
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result35 = testSubject0
                .getTopClassNode();
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result36 = testSubject0
                .getBottomClassNode();
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result37 = testSubject0
        ...
        org.semanticweb.owlapi.reasoner.NodeSet<OWLObjectPropertyExpression> result39 = testSubject0
                .getSubObjectProperties(_OWLObjectPropertyExpression, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLObjectPropertyExpression> result40 = testSubject0
                .getSuperObjectProperties(_OWLObjectPropertyExpression,
                        _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result41 = testSubject0
                .getEquivalentObjectProperties(_OWLObjectPropertyExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLObjectPropertyExpression> result42 = testSubject0
                .getDisjointObjectProperties(_OWLObjectPropertyExpression);
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result43 = testSubject0
                .getInverseObjectProperties(_OWLObjectPropertyExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result44 = testSubject0
                .getObjectPropertyDomains(_OWLObjectPropertyExpression,
                        _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result45 = testSubject0
                .getObjectPropertyRanges(_OWLObjectPropertyExpression, _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result46 = testSubject0
                .getTopDataPropertyNode();
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result47 = testSubject0
                .getBottomDataPropertyNode();
        org.semanticweb.owlapi.reasoner.NodeSet<OWLDataProperty> result48 = testSubject0
                .getSubDataProperties(_OWLDataProperty, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLDataProperty> result49 = testSubject0
                .getSuperDataProperties(_OWLDataProperty, _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result50 = testSubject0
                .getEquivalentDataProperties(_OWLDataProperty);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLDataProperty> result51 = testSubject0
                .getDisjointDataProperties(_OWLDataPropertyExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result52 = testSubject0
                .getDataPropertyDomains(_OWLDataProperty, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLNamedIndividual> result53 = testSubject0
