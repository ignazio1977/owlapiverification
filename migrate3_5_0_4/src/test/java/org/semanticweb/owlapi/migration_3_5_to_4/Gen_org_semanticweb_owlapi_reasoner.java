...
public class Gen_org_semanticweb_owlapi_reasoner {
    ...
    public void verifyAxiomNotInProfileException() {
        AxiomNotInProfileException testSubject0 = new AxiomNotInProfileException(_OWLAxiom, _IRI);
        OWLAxiom result0 = testSubject0.getAxiom();
        IRI result1 = testSubject0.getProfile();
    ...
    public void verifyClassExpressionNotInProfileException() {
        ClassExpressionNotInProfileException testSubject0 = new ClassExpressionNotInProfileException(_OWLClassExpression, _IRI);
    ...
    public void verifyImportsClosureNotInProfileException() {
        ImportsClosureNotInProfileException testSubject0 = new ImportsClosureNotInProfileException(_IRI);
