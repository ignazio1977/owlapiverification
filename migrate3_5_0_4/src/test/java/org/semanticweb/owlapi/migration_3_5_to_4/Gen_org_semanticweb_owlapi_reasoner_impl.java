...
@Migration({ "method change: NodeFactory<init> : private. All methods are static." })
public class Gen_org_semanticweb_owlapi_reasoner_impl {
    ...
    public void verifyDefaultNodeSet() {
        ...
        java.util.Set<org.semanticweb.owlapi.reasoner.Node<OWLClass>> result7 = testSubject0.getNodes();
    ...
    public void verifyOWLClassNode() {
        ...
        org.semanticweb.owlapi.reasoner.impl.OWLClassNode result0 = OWLClassNode.getTopNode();
        org.semanticweb.owlapi.reasoner.impl.OWLClassNode result1 = OWLClassNode.getBottomNode();
        testSubject0.add(_OWLObject);
    ...
    public void verifyOWLDataPropertyNode() {
        ...
        org.semanticweb.owlapi.reasoner.impl.OWLDataPropertyNode result0 = OWLDataPropertyNode.getTopNode();
        org.semanticweb.owlapi.reasoner.impl.OWLDataPropertyNode result1 = OWLDataPropertyNode.getBottomNode();
        ...
        boolean result5 = testSubject0.isTopNode();
        boolean result6 = testSubject0.isBottomNode();
        java.util.Set<OWLDataProperty> result7 = testSubject0.getEntitiesMinus(_OWLDataProperty);
    ...
    public void verifyOWLDataPropertyNodeSet() {
        ...
        boolean result5 = testSubject0.isTopSingleton();
        boolean result6 = testSubject0.isBottomSingleton();
        java.util.Set<org.semanticweb.owlapi.reasoner.Node<OWLDataProperty>> result7 = testSubject0.getNodes();
        testSubject0.addEntity(_OWLDataProperty);
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> np = mock(Node.class);
    ...
    public void verifyOWLDatatypeNodeSet() {
        ...
        boolean result5 = testSubject0.isTopSingleton();
        boolean result6 = testSubject0.isBottomSingleton();
        java.util.Set<org.semanticweb.owlapi.reasoner.Node<OWLDatatype>> result7 = testSubject0.getNodes();
        testSubject0.addEntity(_OWLDatatype);
        org.semanticweb.owlapi.reasoner.Node<OWLDatatype> np = mock(Node.class);
        testSubject0.addNode(np);
        testSubject0.addAllNodes(Arrays.asList(np));
    ...
    public void verifyOWLNamedIndividualNode() {
        ...
        boolean result3 = testSubject0.isTopNode();
        boolean result4 = testSubject0.isBottomNode();
        java.util.Set<OWLNamedIndividual> result5 = testSubject0.getEntitiesMinus(_OWLNamedIndividual);
    ...
    public void verifyOWLNamedIndividualNodeSet() {
        ...
        boolean result5 = testSubject0.isTopSingleton();
        boolean result6 = testSubject0.isBottomSingleton();
        java.util.Set<org.semanticweb.owlapi.reasoner.Node<OWLNamedIndividual>> result7 = testSubject0.getNodes();
        testSubject0.addEntity(_OWLNamedIndividual);
        org.semanticweb.owlapi.reasoner.Node<OWLNamedIndividual> np = mock(Node.class);
        testSubject0.addNode(np);
        testSubject0.addAllNodes(Arrays.asList(np));
    ...
    public void verifyOWLObjectPropertyNode() {
        ...
        org.semanticweb.owlapi.reasoner.impl.OWLObjectPropertyNode result0 = OWLObjectPropertyNode.getTopNode();
        org.semanticweb.owlapi.reasoner.impl.OWLObjectPropertyNode result1 = OWLObjectPropertyNode.getBottomNode();
        ...
        boolean result5 = testSubject0.isTopNode();
        boolean result6 = testSubject0.isBottomNode();
        java.util.Set<OWLObjectPropertyExpression> result7 = testSubject0.getEntitiesMinus(_OWLObjectPropertyExpression);
        java.util.Set<OWLObjectPropertyExpression> result8 = testSubject0.getEntitiesMinusTop();
        java.util.Set<OWLObjectPropertyExpression> result9 = testSubject0.getEntitiesMinusBottom();
        boolean result10 = testSubject0.isSingleton();
    ...
    public void verifyOWLObjectPropertyNodeSet() {
        ...
        boolean result5 = testSubject0.isTopSingleton();
        boolean result6 = testSubject0.isBottomSingleton();
        java.util.Set<org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression>> result7 = testSubject0.getNodes();
        testSubject0.addEntity(_OWLObjectPropertyExpression);
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> np = mock(Node.class);
        testSubject0.addNode(np);
        testSubject0.addAllNodes(Arrays.asList(np));
    ...
    public void verifyOWLReasonerBase() {
        ...
        org.semanticweb.owlapi.reasoner.FreshEntityPolicy result1 = testSubject0.getFreshEntityPolicy();
        org.semanticweb.owlapi.reasoner.IndividualNodeSetPolicy result2 = testSubject0.getIndividualNodeSetPolicy();
        org.semanticweb.owlapi.reasoner.BufferingMode result3 = testSubject0.getBufferingMode();
        java.util.List<OWLOntologyChange<?>> result4 = testSubject0.getPendingChanges();
        java.util.Set<OWLAxiom> result5 = testSubject0.getPendingAxiomAdditions();
        java.util.Set<OWLAxiom> result6 = testSubject0.getPendingAxiomRemovals();
        OWLOntology result7 = testSubject0.getRootOntology();
        org.semanticweb.owlapi.reasoner.OWLReasonerConfiguration result8 = testSubject0.getReasonerConfiguration();
        java.util.Collection<OWLAxiom> result9 = testSubject0.getReasonerAxioms();
        OWLDataFactory result10 = testSubject0.getOWLDataFactory();
        testSubject0.dispose();
        testSubject0.interrupt();
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result11 = testSubject0.getSuperClasses(_OWLClassExpression, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result12 = testSubject0.getSubClasses(_OWLClassExpression, _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result13 = testSubject0.getEquivalentClasses(_OWLClassExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result14 = testSubject0.getDisjointClasses(_OWLClassExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result15 = testSubject0.getTypes(_OWLNamedIndividual, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLNamedIndividual> result16 = testSubject0.getObjectPropertyValues(_OWLNamedIndividual, _OWLObjectPropertyExpression);
        java.util.Set<OWLLiteral> result17 = testSubject0.getDataPropertyValues(_OWLNamedIndividual, _OWLDataProperty);
        org.semanticweb.owlapi.reasoner.Node<OWLNamedIndividual> result18 = testSubject0.getSameIndividuals(_OWLNamedIndividual);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLNamedIndividual> result19 = testSubject0.getDifferentIndividuals(_OWLNamedIndividual);
        ...
        java.util.Set<org.semanticweb.owlapi.reasoner.InferenceType> result23 = testSubject0.getPrecomputableInferenceTypes();
        boolean result24 = testSubject0.isConsistent();
        boolean result25 = testSubject0.isSatisfiable(_OWLClassExpression);
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result26 = testSubject0.getUnsatisfiableClasses();
        ...
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result30 = testSubject0.getTopClassNode();
        org.semanticweb.owlapi.reasoner.Node<OWLClass> result31 = testSubject0.getBottomClassNode();
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result32 = testSubject0.getTopObjectPropertyNode();
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result33 = testSubject0.getBottomObjectPropertyNode();
        org.semanticweb.owlapi.reasoner.NodeSet<OWLObjectPropertyExpression> result34 = testSubject0.getSubObjectProperties(_OWLObjectPropertyExpression, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLObjectPropertyExpression> result35 = testSubject0.getSuperObjectProperties(_OWLObjectPropertyExpression, _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result36 = testSubject0.getEquivalentObjectProperties(_OWLObjectPropertyExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLObjectPropertyExpression> result37 = testSubject0.getDisjointObjectProperties(_OWLObjectPropertyExpression);
        org.semanticweb.owlapi.reasoner.Node<OWLObjectPropertyExpression> result38 = testSubject0.getInverseObjectProperties(_OWLObjectPropertyExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result39 = testSubject0.getObjectPropertyDomains(_OWLObjectPropertyExpression, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result40 = testSubject0.getObjectPropertyRanges(_OWLObjectPropertyExpression, _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result41 = testSubject0.getTopDataPropertyNode();
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result42 = testSubject0.getBottomDataPropertyNode();
        org.semanticweb.owlapi.reasoner.NodeSet<OWLDataProperty> result43 = testSubject0.getSubDataProperties(_OWLDataProperty, _boolean);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLDataProperty> result44 = testSubject0.getSuperDataProperties(_OWLDataProperty, _boolean);
        org.semanticweb.owlapi.reasoner.Node<OWLDataProperty> result45 = testSubject0.getEquivalentDataProperties(_OWLDataProperty);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLDataProperty> result46 = testSubject0.getDisjointDataProperties(_OWLDataPropertyExpression);
        org.semanticweb.owlapi.reasoner.NodeSet<OWLClass> result47 = testSubject0.getDataPropertyDomains(_OWLDataProperty, _boolean);
    ...
    public void verifySatisfiabilityReducer() {
        ...
        Object result4 = testSubject0.visit(_OWLInverseFunctionalObjectPropertyAxiom);
        ...
        Object result22 = testSubject0.visit(_OWLEquivalentObjectPropertiesAxiom);
        Object result23 = testSubject0.visit(_OWLNegativeDataPropertyAssertionAxiom);
        Object result24 = testSubject0.visit(_OWLDifferentIndividualsAxiom);
        Object result25 = testSubject0.visit(_OWLSubClassOfAxiom);
        Object result26 = testSubject0.visit(_OWLNegativeObjectPropertyAssertionAxiom);
